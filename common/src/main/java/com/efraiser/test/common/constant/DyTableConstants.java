...
public class DyTableConstants {
	...
	//上海自定义报表模版信息缓存
	public static String DY_SH_TABLE_CACHE_KEY = "DY_SH_TABLE_CACHE_KEY";
	public static String DY_SH_TABLE_TV_CACHE_KEY = "DY_SH_TABLE_TV_CACHE_KEY";
	public static String DY_SH_TABLE_PCT_CACHE_KEY = "DY_SH_TABLE_PCT_CACHE_KEY";
	public static String DY_SH_TABLE_CN_CACHE_KEY = "DY_SH_TABLE_CN_CACHE_KEY";
	public static String DY_SH_TABLE_FI_CACHE_KEY = "DY_SH_TABLE_FI_CACHE_KEY";
	public static String DY_SH_QUERY_SQL_KEY = "DY_SH_TABLE_QUERY_SQL_";
	public static String DY_SH_QUERY_VALUE_SQL_KEY = "DY_SH_TABLE_QUERY_VALUE_SQL_";
	
	//上海小册子模版信息缓存
		public static String DY_XCZ_TABLE_CACHE_KEY = "DY_XCZ_TABLE_CACHE_KEY";
		public static String DY_XCZ_TABLE_TV_CACHE_KEY = "DY_XCZ_TABLE_TV_CACHE_KEY";
		public static String DY_XCZ_TABLE_PCT_CACHE_KEY = "DY_XCZ_TABLE_PCT_CACHE_KEY";
		public static String DY_XCZ_TABLE_CN_CACHE_KEY = "DY_XCZ_TABLE_CN_CACHE_KEY";
		public static String DY_XCZ_TABLE_FI_CACHE_KEY = "DY_XCZ_TABLE_FI_CACHE_KEY";
		public static String DY_XCZ_QUERY_SQL_KEY = "DY_XCZ_TABLE_QUERY_SQL_";
		public static String DY_XCZ_QUERY_VALUE_SQL_KEY = "DY_XCZ_TABLE_QUERY_VALUE_SQL_";
		public static String DY_XCZ_TABLE_MODEL_HTML_KEY = "DY_XCZ_TABLE_MODEL_HTML_";
		public static String DY_XCZ_TABLE_MODEL_JG_HTML_KEY="DY_XCZ_TABLE_MODEL_JG_HTML_";
	//上海自定义模块报表模板HTML信息
	public static String DY_SH_TABLE_MODEL_HTML_KEY = "DY_SH_TABLE_MODEL_HTML_";
}
