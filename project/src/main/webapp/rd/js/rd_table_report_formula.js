...
function addFormula(){
	...
	if(inputId!=""&&inputId.indexOf("_")>=0){
		mini.open({
			type : 'POST',
			url : base + 'rd/check/wave/getFormulaByReport.nut?tableId='+tableId+'&versionNo='+versionNo+'&inputId='+inputId+'&cUser='+cUser+'&searchBrno='+searchBrno+'&page=/rd/jsp/rd_check_formula_yidong2.jsp',
			title : '跨期异动公式',
			iconCls : 'icon-edit',
			width : 1120,
			height : 450,
