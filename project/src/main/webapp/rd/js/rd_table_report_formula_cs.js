...
function addFormula(){
	...
	if(inputId!=""&&inputId.indexOf("_")>=0){
		mini.open({
			type : 'POST',
			url : base + 'rd/check/wave/getFormulaByReportCS.nut?tableId='+tableId+'&versionNo='+versionNo+'&inputId='+inputId+'&cUser='+cUser+'&page=/rd/jsp/rd_check_formula_yidong_cs.jsp',
			title : '跨期异动公式',
			iconCls : 'icon-edit',
			width : 900,
			height : 450,
