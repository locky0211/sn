...
function add(){
	...
	if(form.isValid()&&checkIsNumber()){
		...
		$.ajax({
					url : base + 'rd/check/wave/autoAddFormulaYidong.nut?tabCode='+tabCode+'&checkRisk='+checkRisk+'&reportRate='+reportRate+'&leftValue='+leftValue+'&rightValue='+rightValue+'&thisVersion='+thisVersion+'&checkBrno='+checkBrno+'&cUser='+cUser+'&reportDate='+reportDate,
					type : 'post',
					dataType : 'json',
					cache : false,
