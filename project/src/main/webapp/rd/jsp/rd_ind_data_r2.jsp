...
<script type="text/javascript" src="../js/rd_ind_data_r2.js"></script>
				...
				<thead>
					<tr>
						<td style="width: 100%;">指标：<input id="inds" style="width: 300px;" popupHeight="350px;" popupWidth="350px;" required="true"
							class="mini-treeselect" url="${base }/rd/indicators/getIndicatorsBasicInfoList.nut" textField="indName" multiSelect="false" parentField="pId"
							valueField="id" resultAsTree="false" allowInput="false" onbeforenodeselect="beforenodeselect" onvaluechanged="loadBrNos" /> 机构: <input
							id="brNo" name="brNo" style="width: 250px;" popupHeight="450px;" popupWidth="350px;" required="true" class="mini-treeselect" url="${base }/sys/bm/getSysBmListByUserIdForRd.nut"
