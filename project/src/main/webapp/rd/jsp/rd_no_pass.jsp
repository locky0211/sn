...
<script type="text/javascript" src="../js/rd_no_pass.js"></script>
</head>
<body>
	<!--撑满页面-->
	<div class="mini-fit">
		<div id="checkLogViewGrid" class="mini-datagrid"  allowAlternating="true"  onrowclick="showCheckView" borderStyle="border:0" style="width: 100%; height: 100%"
			url="${base}/rd/check/log/getCheckNoPassNumCheckResults.nut?areaCode=${param.areaCode}&reportDate=${param.reportDate}&tabType=${param.tabType}&checkRisk=${param.checkRisk}"
			showPager="false">
