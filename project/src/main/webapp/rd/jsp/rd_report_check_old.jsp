...
<script type="text/javascript" src="../js/rd_report_check_old.js"></script>
<script>
$(function() {
...
<body>
	...
	<div class="mini-fit">
		<div id="reportCheckGrid" class="mini-datagrid" onrowclick="showCheckView" style="width: 100%; height: 100%"
			url="${base}/rd/check/getRdReportCheckResults.nut" showPager="false" onload="onGridLoad" allowAlternating="true">
