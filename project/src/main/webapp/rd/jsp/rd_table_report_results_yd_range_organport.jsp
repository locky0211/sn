<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ taglib prefix="rdr" uri="../tld/table_report_results_yd_range_organport.tld"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>异动校验结果页(机构端)</title>
...
<script type="text/javascript" src="${base }/rd/js/rd_table_report_results_yd_range_organport.js"></script>
</head>
		...
		<div id="layout1" class="mini-layout" style="width: 100%; height: 100%;" splitSize="0">
			<div title="center" region="center" style="border: 0;" bodyStyle="padding: 0px;">
				<form id="rdTableReportForm" action="">
					...
					<rdr:rdReportResultsRangeOrganPortTag tableId="${tableInfo.tableId }" brNo="${brNo }" reportDate="${reportDate }" checkType="${checkType }" cUser="${cUser }" isdValue="${isdValue }" ></rdr:rdReportResultsRangeOrganPortTag>
				</form>
			</div>
		</div>
	</c:if>
