...
<script type="text/javascript" src="../js/rd_summaryReport_check_old.js"></script>
<script>
$(function() {
...
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><label style="font-family: Verdana;"> 机构: </label> <input id="bmCode" showClose="true" oncloseclick="onCloseClick"
						...
						&nbsp;&nbsp;公式类型:&nbsp;
						<input id="formulaType" showNullItem="false" name="formulaType" textField="typeName" valueField="typeValue" class="mini-combobox"  style="width: 80px;height:100%" data="[{typeValue:'1',typeName:'普通'}]"
						allowInput="false" />
	...
	<div class="mini-fit">
		<div id="reportCheckGrid" class="mini-datagrid" onrowclick="showCheckView" style="width: 100%; height: 100%"
			url="${base}/rd/check/getSummaryRdReportCheckResults.nut" showPager="false" onload="onGridLoad" allowAlternating="true">
