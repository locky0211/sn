...
<script type="text/javascript" src="../../rd/js/rd_table_list_cs.js"></script>
</head>
<body>
			...
			<table style="width: 100%;">
				...
				<tr>
					...
					<td><input id="thisVersion" name="thisVersion" style="width: 180px;" showClose="true" oncloseclick="onCloseClick"
						class="mini-combobox" url="${base }/rd/table/getTableVersionNo.nut" textField="versionNo" multiSelect="false" 
	...
	<div class="mini-fit">
		<div id="tableListGrid" class="mini-datagrid" multiSelect="true" onrowdblclick="showReportView" style="width: 100%; height: 100%"
			url="${base}/rd/table/getCheckFormulaYidongReport.nut" showPager="false"  allowAlternating="true" >
