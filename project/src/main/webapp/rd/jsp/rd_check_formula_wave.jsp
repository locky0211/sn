...
<script type="text/javascript" src="${base}/rd/js/rd_check_formula_wave.js"></script>
</head>
			...
			<table cellpadding="4" cellspacing="4" style="padding-left: 12px;">
				<tr>
					...
					<td colspan="3"><input id="tabcode" name="tabcode" class="mini-textbox" required="true" onchange="isincludSpace" style="width: 400px;"
						...
						<input id="cUser" name="cUser" class="mini-hidden" value="${obj.cUser }"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td>关注等级</td>
					<td><input id="checkRisk" name="checkRisk" class="mini-combobox" style="width: 150px;"  popupWidth="150" textField="zdName" valueField="zdValue" url="${base }/sys/ggzd/getGgzdList.nut?groupId=WAVE_CHECK_RISK" required="true"
					...
					<td><input id="checkBrno" name="checkBrno" style="width: 150px;" showClose="true" oncloseclick="onCloseClick" style="width: 250px;"  popupHeight="300px;" popupWidth="350px;" showFolderCheckBox="true" 
						checkRecursive="true" multiSelect="false" class="mini-treeselect" url="${base }/sys/bm/getSysBmListByUserIdAndTabcode.nut?tabcode=${obj.tabcode }" textField="bmName" multiSelect="false" parentField="pId" 
						valueField="bmCode" resultAsTree="false" allowInput="false"  value="${obj.checkBrno}" /></td>
				</tr>
				<tr>
					<td>校验频度</td>
