...
<script type="text/javascript" src="../js/rd_indicators_basic_info.js"></script>
</head>
			...
			<c:if test="${param.isParent=='y'}">
				<tr>
					...
					<td class="tab_field_nr" colspan="3"><input name="pId" style="width: 220px;" showClose="true" oncloseclick="onCloseClick"
						class="mini-treeselect" url="${base }/rd/indicators/getIndicatorsTypeList.nut" textField="indName" parentField="pId" valueField="id"
			...
			<c:if test="${param.isParent=='n'}">
				...
				<tr>
					...
					<td class="tab_field" colspan="3"><input name="pId" style="width: 200px;" required="true" class="mini-treeselect"
						url="${base }/rd/indicators/getIndicatorsTypeList.nut" textField="indName" parentField="pId" valueField="id" value="${obj.pId}"
				...
				<tr>
					...
					<td class="tab_field_nr" colspan="3"><input id="indType" name="indType" class="mini-combobox" style="width: 100px;" textField="zdName"
						valueField="zdValue" url="${base }/sys/ggzd/getGgzdList.nut?groupId=RD_IND_CYCLE" required="true" allowInput="false" value="${obj.indType }" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="tab_label">适用区域：</td>
					<td class="tab_field_nr" colspan="3"><input name="area" style="width: 400px;" showClose="true" required="true"
						oncloseclick="onCloseClick" class="mini-treeselect" url="${base }/sys/ggzd/getGgzdList.nut?groupId=SYS_USER_ORGAN" textField="zdName"
						multiSelect="true" parentField="pId" showCheckBox="true" showFolderCheckBox="true" valueField="zdValue" value="${obj.area}" resultAsTree="false" allowInput="false"
						expandOnNodeClick="true" /></td>
				</tr>
			</c:if>
		</table>
