...
<title>异动校验(机构端)</title>
<%@include file="../../common/quote/boot.html"%>
<script type="text/javascript" src="../js/rd_report_check_yd_organport.js"></script>
...
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><label style="font-family: Verdana;"> 机构: </label> <input id="bmCode" showClose="true" oncloseclick="onCloseClick" name="brNo" style="width: 250px;"
						...
						<a class="mini-button" iconCls="icon-excel" onclick="downLoadYdExcel(1)">异动情况导出</a>&nbsp;&nbsp;<a class="mini-button" iconCls="icon-excel" onclick="downLoadYdExcel(2)">异动说明导出</a>
						<a class="mini-button" iconCls="icon-ok" onclick="commitYDInfo">异动报备</a></td>
				</tr>
				<!-- <tr>
	...
	<!--撑满页面-->
	<div class="mini-fit">
		<div id="reportCheckGrid" class="mini-datagrid" multiSelect="true" style="width: 100%; height: 100%" url="${base}/rd/check/wave_organport/getRdCheckInfoListByBrNoForYD_OrganPort.nut" showPager="false"
