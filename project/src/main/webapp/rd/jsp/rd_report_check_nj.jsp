...
<title>南京省局异动追数</title>
<%@include file="../../common/quote/boot.html"%>
<script type="text/javascript" src="../js/rd_report_check_nj.js"></script>
</head>
<body>
	...
	<!--撑满页面-->
	<div class="mini-fit">
		<div id="reportCheckGrid" class="mini-datagrid" multiSelect="true" style="width: 100%; height: 100%" url="${base}/rd/check/wave/getRdCheckInfoListByBrNoForYD_NJ.nut" showPager="false"
