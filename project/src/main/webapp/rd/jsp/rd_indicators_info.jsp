...
<script type="text/javascript" src="../js/rd_indicators_info.js"></script>
</head>
		...
		<table style="width: 100%" cellpadding="5" cellspacing="0">
			<tr>
				...
				<td class="tab_field_nr" colspan="3"><input name="indDate" id="indDate" onvalidation="checkIndDate" class="mini-combobox" required="true"
					style="width: 150px;" textField="zdName" valueField="zdValue" url="${base }/sys/ggzd/getGgzdList.nut?groupId=RD_IND_DATE" value="${obj.indDate }"
					allowInput="false" /></td>
			</tr>
			<tr>
