...
<script type="text/javascript" src="../js/rd_report_base_check_nj.js"></script>
<script>
$(function() {
...
<body>
	...
	<div class="mini-fit">
		<div id="reportCheckGrid" class="mini-datagrid" onrowclick="showCheckView" style="width: 100%; height: 100%"
			url="${base}/rd/check/getRdReportCheckResultsSh.nut" showPager="false" onload="onGridLoad" allowAlternating="true">
			<div property="columns">
				...
				<div field="num" width="15" allowSort="true" headerAlign="center" align="center" >可追溯数量</div>
			</div>
		</div>
	</div>
