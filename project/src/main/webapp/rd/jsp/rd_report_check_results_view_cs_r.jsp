...
<script type="text/javascript" src="../js/rd_report_check_results_view_cs.js"></script>
</head>
<body style="overflow: auto;">
	<table class="tab" cellpadding="4" cellspacing="0" style="width: 100%">
		...
		<tr>
		 ...
		 <tr>
			<td class="tab_label" valign="top">备注信息：</td>
			<td colspan="3" class="tab_field_nr">${obj.remarks }</td>
		</tr>
		  <tr>
			<td class="tab_label" valign="top">审核意见：</td>
			<td colspan="3" class="tab_field_nr">${obj.reviewAdvice}</td>
		</tr>
		<tr>
