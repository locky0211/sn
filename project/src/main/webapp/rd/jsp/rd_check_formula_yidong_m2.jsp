...
<script type="text/javascript" src="../js/rd_check_formula_yidong_m2.js"></script>
</head>
<body>
	...
	<div class="mini-fit">
		<div id="checkFormulaGrid" class="mini-treegrid" style="width: 100%; height: 100%"  showTreeIcon="true"
			...
			<div property="columns">
				<div type="indexcolumn" width="8px" headerAlign="center" cellStyle="cursor: pointer;">序号</div>
				<div field="checkProject" sortField="CHECK_PROJECT" name="checkProject" allowSort="true" headerAlign="center">项目</div>
				<div field="startDate" width="20px" allowSort="false" headerAlign="center">本期版本号</div>
				<div field="endDate" width="20px" allowSort="false" headerAlign="center">上期版本号</div>
				<div field="checkBrno" width="40px" allowSort="false" headerAlign="center">适用机构</div>
