...
<script type="text/javascript" src="${base }/rd/js/autoAddFormulaYidong.js"></script>
<title>同版本批量导入</title>
</head>
<body>
	<div>
	...
	<div>
		<form id="autoFormula">
			<table class="tab" cellpadding="4" cellspacing="0" style="width: 100%">
				...
				<tr>
					<td class="tab_label" style="display: none;">适用机构：</td>
					<td class="tab_field" style="display: none;"><input id="checkBrno" name="checkBrno" style="width: 180px;" showClose="true" oncloseclick="onCloseClick" style="width: 200px;"  popupHeight="200px;" popupWidth="350px;" showFolderCheckBox="true" 
