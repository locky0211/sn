...
<%@ taglib prefix="rdr" uri="../tld/table_report_results_yd_range_nj.tld"%>
...
<script type="text/javascript" src="${base }/rd/js/rd_table_report_results_yd_range_nj.js"></script>
<title>南京省局追数</title>
</head>
		...
		<div id="layout1" class="mini-layout" style="width: 100%; height: 100%;" splitSize="0">
			<div title="center" region="center" style="border: 0;" bodyStyle="padding: 0px;">
				<form id="rdTableReportForm" action="">
					...
					<rdr:rdReportResultsRangeNjTag tableId="${tableInfo.tableId }" brNo="${brNo }" reportDate="${reportDate }" checkType="${checkType }" cUser="${cUser }" isdValue="${isdValue }"></rdr:rdReportResultsRangeNjTag>
				</form>
			</div>
		</div>
	</c:if>
