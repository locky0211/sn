...
<script type="text/javascript" src="${base }/rd/js/rd_table_report_results_yd_range_jg.js"></script>
<title>报表数据页</title>
</head>
		...
		<div id="layout1" class="mini-layout" style="width: 100%; height: 100%;" splitSize="0">
			<div title="center" region="center" style="border: 0;" bodyStyle="padding: 0px;">
				<form id="rdTableReportForm" action="">
					...
					<rdr:rdReportResultsRangeJGTag tableId="${tableInfo.tableId }" brNo="${brNo }" reportDate="${reportDate }" checkType="${checkType }" cUser="${cUser }" isdValue="${isdValue }" ></rdr:rdReportResultsRangeJGTag>
				</form>
			</div>
		</div>
	</c:if>
