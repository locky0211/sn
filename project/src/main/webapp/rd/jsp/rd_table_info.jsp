...
<script type="text/javascript" src="../js/rd_table_info.js"></script>
</head>
			...
			<table style="width: 100%" cellpadding="5">
				...
				<tr>
					...
					<td><input id="tabType" name="tabType" class="mini-combobox" style="width: 115px;" textField="zdName" valueField="zdValue"
						url="${base }/sys/ggzd/getGgzdList.nut?groupId=RD_TABLE_TAB_TYPE" required="true" allowInput="false" value="${tInfo.tabType}" /></td>
					<td>报送类型：</td>
			...
			<table style="width: 100%" cellpadding="5">
				<tr>
					...
					<td><input id="versionNo" name="versionNo" class="mini-combobox" style="width: 120px;" textField="zdName" valueField="zdValue"
						url="${base }/sys/ggzd/getGgzdList.nut?groupId=RD_TABLE_VERSION_NO" required="true" allowInput="false" value="${tInfo.versionNo}" /></td>
				</tr>
				<tr>
					<td>启用日期：</td>
				...
				<tr>
					<td>版本号坐标：</td>
					<td><input id="versionNoInfo" name="versionNoInfo" class="mini-textbox" style="width: 120px;" required="true" value="${tInfo.versionNoInfo}" /></td>
				</tr>
				<tr>
					<td>匹配关键字：</td>
