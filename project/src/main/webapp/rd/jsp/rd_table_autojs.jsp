...
<script type="text/javascript" src="../js/rd_table_autojs.js"></script>
</head>
<body>
	...
	<!--撑满页面-->
	<div class="mini-fit">
		<div id="tableInfoGrid"  allowAlternating="true"  class="mini-datagrid" multiSelect="true" style="width: 100%; height: 100%" url="${base}/rd/table/getTableBasicInfoList.nut"
