...
<script type="text/javascript" src="../js/rd_ind_data_r1.js"></script>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><label style="font-family: Verdana;">机构: </label> <input id="brNo" name="brNo" style="width: 250px;" popupHeight="450px;" popupWidth="350px;" required="true"
						class="mini-treeselect" url="${base }/sys/bm/getSysBmListByUserIdForRd.nut" value="<%= brno%>" textField="bmName" parentField="pId" valueField="bmCode" resultAsTree="false" allowInput="false"
						...
						valueField="zdValue" url="${base }/sys/ggzd/getGgzdList.nut?groupId=RD_IND_CYCLE" required="true" allowInput="false" onvaluechanged="initRdIndList()" />&nbsp;&nbsp;&nbsp;指标：<input id="inds"
