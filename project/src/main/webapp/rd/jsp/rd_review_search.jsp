...
<script type="text/javascript" src="../js/rd_review_search.js"></script>
...
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><label style="font-family: Verdana;"> 机构: </label> <input id="bmCode" showClose="true" oncloseclick="onCloseClick" name="brNo" style="width: 250px;"
						popupHeight="300px;" popupWidth="350px;" multiSelect="true" showFolderCheckBox="true" checkRecursive="true" required="false" class="mini-treeselect" url="${base }/sys/bm/getSysBmListByUserId.nut"
	...
	<div class="mini-fit">
		...
		<div id="remarksResultGrid" allowAlternating="true" class="mini-datagrid"  style="width: 100%; height: 100%;" url="${base}/rd/remarks/getRdRemarksHistoryRecord.nut"
