...
<script type="text/javascript" src="../js/rd_ind_data.js"></script>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><label style="font-family: Verdana;">&nbsp;&nbsp;&nbsp;机构:&nbsp;</label> <input id="brNo" name="brNo" style="width: 250px;" popupHeight="350px;" popupWidth="450px;"
						required="true" class="mini-treeselect" url="${base }/sys/bm/getSysBmListByUserIdForRd.nut" value="<%= brno%>" textField="bmName" multiSelect="false" parentField="pId" valueField="bmCode"
						...
						class="mini-monthpicker" format="yyyyMM" required="true"  onvaluechanged="dataDateChanged()"/>&nbsp;&nbsp;&nbsp;指标周期:&nbsp;&nbsp;&nbsp;<input id="indType" name="indType" class="mini-combobox" style="width: 80px;"
						textField="zdName" valueField="zdValue" required="true" allowInput="false" value="${obj.indType }" />&nbsp;&nbsp;&nbsp;<a
