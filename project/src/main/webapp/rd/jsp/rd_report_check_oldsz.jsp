...
<script type="text/javascript" src="../js/rd_report_check_oldsz.js"></script>
<script>
$(function() {
...
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><label style="font-family: Verdana;"> 机构: </label> <input id="bmCode" showClose="true" oncloseclick="onCloseClick"
						...
						&nbsp;&nbsp;是否通过:&nbsp; <input id="checkFlag"
						name="checkFlag" class="mini-combobox" style="width: 80px;" textField="zdName" valueField="zdValue"
						url="${base }/sys/ggzd/getGgzdList.nut?groupId=RD_CHECK_FLAG" showNullItem="true" required="false" allowInput="false" />
						
						<a class="mini-button" iconCls="icon-search" onclick="gridLoad()">查找</a>
	...
	<div class="mini-fit">
		<div id="reportCheckGrid" class="mini-datagrid" onrowdblclick="showCheckView" style="width: 100%; height: 100%"
			url="${base}/rd/checksz/getRdReportCheckResults.nut" pageSize="150"  showPager="true" onload="onGridLoad" allowCellEdit="true" allowCellSelect="true" multiSelect="true" showModified="false">
			<div property="columns">
				...
				<div field="content" width="80" headerAlign="center" renderer="onErrorMsgRenderer">校验信息</div>
				<div field="formulaMark" width="40" headerAlign="center">公式描述</div>
				<div field="checkFlag" sortField="CHECK_FLAG" allowSort="true" width="20" align="center" headerAlign="center" renderer="onFlagRenderer">是否通过</div>
