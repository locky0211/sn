...
<title>省局存档问题查看</title>
<%@include file="../../common/quote/boot.html"%>
<script type="text/javascript" src="../js/rd_file_view.js"></script>
</head>
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;">
						...
						&nbsp;&nbsp;存档类型:&nbsp;
						<input id="istrue" name="istrue" class="mini-combobox" style="width: 100px;" showNullItem="true"  style="width: 60px;"
							textField="istrueName" valueField="istrueValue" data="[{istrueValue:'1',istrueName:'存档-有问题'},{istrueValue:'0',istrueName:'存档-无问题'}]" allowInput="false" value="" />  
						&nbsp;&nbsp;
	...
	<div class="mini-fit">
		<div id="issuedResultGrid" allowAlternating="true" class="mini-datagrid" onrowdblclick="showCheckView" style="width: 100%; height: 100%;" url="${base}/rd/problemIssued/getRdProblemIssuedSavedList.nut"
			pageSize="20" allowAlternating="true" showPager="true" showModified="true" allowCellEdit="true" allowCellSelect="true" allowCellWrap="false">
