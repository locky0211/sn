...
<script type="text/javascript" src="../js/rd_check_result_record.js"></script>
<style type="text/css">
a {
...
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;">地区:&nbsp; <input name="bmArea" style="width: 80px;" class="mini-treeselect"
						...
						textField="zdName" valueField="zdValue" url="${base }/sys/ggzd/getGgzdList.nut?groupId=RD_TABLE_TAB_TYPE" required="true" allowInput="false"
	...
	<div class="mini-fit">
		<div id="checkLogGrid" class="mini-datagrid" allowAlternating="true" style="width: 100%; height: 100%"
			url="${base}/rd/check/log/getRdReportCheckLogRecord.nut" showPager="false">
