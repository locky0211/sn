...
<input id="reportDate" name="reportDate" class="mini-hidden" value="${param.reportDate}" />
	<!--撑满页面-->
	<div class="mini-fit">
		<div id="showViewGrid" class="mini-datagrid"  style="width: 100%; height: 100%" onrowdblclick="showRdCheckResultView"
			url="${base}/rd/rdAuditSchedule/showView.nut" showPager="false"  allowAlternating="true" >
