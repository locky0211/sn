...
<title>报表数据逻辑校验(机构端)</title>
<%@include file="../../common/quote/boot.html"%>
<script type="text/javascript" src="../js/rd_report_check_organport.js"></script>
<script>
$(function() {
...
<div id="reportCheckForm">
	...
	<div class="mini-fit">
		<div id="reportCheckGrid" class="mini-datagrid" onrowclick="showCheckView" style="width: 100%; height: 100%"
			url="${base}/rd/check_organport/getRdReportCheckResults_OrganPortVo.nut" showPager="false" onload="onGridLoad" allowAlternating="true">
			<div property="columns">
				...
				<div field="diffValue" width="20" allowSort="true" headerAlign="center" align="right">差值</div>
