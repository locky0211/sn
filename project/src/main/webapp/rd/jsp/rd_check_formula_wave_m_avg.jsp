...
<title>上海校验公式信息维护</title>
<%@include file="../../common/quote/boot.html"%>
<script type="text/javascript" src="../js/rd_check_formula_wave_m_avg.js"></script>
</head>
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;">
						...
						&nbsp;&nbsp;关注等级：
						<input id="checkRisk" class="mini-combobox" style="width: 150px;"  popupWidth="150" textField="zdName" valueField="zdValue"
						...
						&nbsp;&nbsp;类型：
						<input id="type" name="type" class="mini-combobox" showNullItem="true"  style="width: 60px;"
							textField="typeName" valueField="typeValue" data="[{typeValue:'fr',typeName:'法人'},{typeValue:'fz',typeName:'分支'}]" allowInput="false" value="" />
	...
	<div class="mini-fit">
		<div id="checkFormulaGrid" class="mini-datagrid" style="width: 100%; height: 100%;"
			url="${base}/rd/check/wave/getCheckFormulaWaveAvgList.nut" allowAlternating="true" pageSize="20" multiSelect="true"
			showModified="false">
			<div property="columns">
				...
				<div field="element" width="30" align="center" allowSort="true" headerAlign="center">本期坐标</div>
				<div field="lastElement" width="30" align="center" allowSort="true" headerAlign="center">上期坐标</div>
				...
				<div field="validFlag" width="20" align="center" allowSort="true" headerAlign="center" renderer="onValidRenderer">状态</div>
				<div field="type" width="20" allowSort="true" align="center" headerAlign="center" name="type" renderer="typeRenderer">公式类型</div>
