...
<script type="text/javascript" src="../js/rd_report_check_jg.js"></script>
</head>
<body>
	<div id="reportCheckForm">
		<div class="mini-toolbar">
			<table style="width: 100%;">
				<tr>
					<td style="width: 80%;"><label style="font-family: Verdana;"> 机构: </label> <input id="bmCode" showClose="true" oncloseclick="onCloseClick" name="brNo" style="width: 250px;"
						popupHeight="300px;" popupWidth="350px;" showFolderCheckBox="true" checkRecursive="true" multiSelect="false" required="true" class="mini-treeselect" url="${base }/sys/bm/getSysBmListByUserIdForRd.nut"
						...
						onclick="doExportExcel('0')">导出波动值</a>&nbsp;&nbsp;&nbsp;<a class="mini-button" iconCls="icon-down" onclick="doExportExcel('1')">导出差值</a>
						<a class="mini-button" iconCls="icon-excel" onclick="downLoadYdExcel(1)">异动情况导出</a>&nbsp;&nbsp;<a class="mini-button" iconCls="icon-excel" onclick="downLoadYdExcel(2)">异动说明导出</a></td>
				</tr>
				<!-- <tr>
