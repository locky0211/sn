...
<script type="text/javascript" src="../js/rd_indicators_info_update.js"></script>
</head>
<body>
	<!--撑满页面-->
	<div class="mini-fit">
		<div id="indicatorsInfoGrid" class="mini-datagrid" borderStyle="border:0;" style="width: 100%; height: 100%"
			url="${base}/rd/indicators/getIndicatorsInfoList.nut?indName=${param.indName}" showPager="false">
