...
<script type="text/javascript" src="${base }/rd/js/rd_report_check_results_view_wave_nj.js"></script>
</head>
<body style="overflow: auto;">
	<table class="tab" cellpadding="4" cellspacing="0" style="width: 100%">
		...
		<tr>
			<td colspan="2" class="tab_align_c"><a class="mini-button" onclick="javascript:CloseWindow('ok'),showTab()" style="width: 80px;">开始追溯</a></td>
