...
<script type="text/javascript" src="../js/rd_indicators_info_m.js"></script>
</head>
<body>
	...
	<!--撑满页面-->
	<div class="mini-fit">
		<div id="indicatorsInfoGrid" style="width: 100%; height: 100%;" class="mini-treegrid" url="${base}/rd/indicators/getIndicatorsBasicInfoList.nut"
