...
<script type="text/javascript" src="../js/rd_report_check_yd_cs.js"></script>
...
<body>
	...
	<!--撑满页面-->
	<div class="mini-fit">
		<div id="reportCheckGrid" class="mini-datagrid" onrowdblclick="showCheckView" style="width: 100%; height: 100%" url="${base}/rd/check/wave/getRdReportCheckResultsSearch.nut" showPager="false"
