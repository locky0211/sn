...
<script type="text/javascript" src="../js/rd_ind_cal2.js"></script>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><label style="font-family: Verdana;">指标：<input id="indTree" required="true" style="width: 250px;"
							popupHeight="450px;" popupWidth="380px;" required="true" class="mini-treeselect" url="${base }/rd/indicators/getIndicatorsBasicInfoList.nut"
						...
						required="true" class="mini-treeselect" url="${base }/sys/bm/getSysBmListByUserId.nut" value="<%= brno%>" textField="bmName" multiSelect="true" parentField="pId"
