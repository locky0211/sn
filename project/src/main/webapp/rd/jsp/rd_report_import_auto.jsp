...
<script type="text/javascript" src="../js/rd_report_import_auto.js"></script>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><label style="font-family: Verdana;">机构: </label> <input id="bmCode" name="brNo" style="width: 250px;" popupHeight="350px;" popupWidth="450px;" required="true"
						...
						<div id="autoZero" name="autoZero" class="mini-checkbox" readOnly="false" text="自动补零" value="1"></div>
						&nbsp;&nbsp;
						<a class="mini-button" iconCls="icon-upload2" onclick="doReportImport(1)">登录</a>
						&nbsp;&nbsp;
						<a class="mini-button" iconCls="icon-upload2" onclick="doReportImport(2)">是否登录</a>
						&nbsp;&nbsp;
						<a class="mini-button" iconCls="icon-upload2" onclick="doReportImport(3)">登出</a>
						&nbsp;&nbsp;
