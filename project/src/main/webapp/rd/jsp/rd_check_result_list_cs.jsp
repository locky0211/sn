...
<script type="text/javascript" src="../js/rd_check_result_list_cs.js"></script>
...
<body>
	...
	<div class="mini-fit">
		<div id="checkResultGrid" allowAlternating="true" class="mini-datagrid" onrowclick="showCheckView" style="width: 100%; height: 100%;" url="${base}/rd/check_cs/getRdReportCheckResultListArea.nut"
