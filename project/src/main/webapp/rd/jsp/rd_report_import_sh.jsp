...
<script type="text/javascript" src="../js/rd_report_import_sh.js"></script>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><label style="font-family: Verdana;">机构: </label> <input id="bmCode" name="brNo" style="width: 250px;" popupHeight="350px;" popupWidth="450px;" required="true"
						...
						onuploadsuccess="onUploadsuccess" /><a class="mini-button" iconCls="icon-upload2" onclick="doRepayImportCj()">导入</a> <!-- <a class="mini-button" iconCls="icon-upload2" onclick="doReportImport()">导入</a> --><!--  <a class="mini-button" iconCls="icon-excel" onclick="doReportExport()">导出</a> -->
						<a class="mini-button" iconCls="icon-excel" onclick="downLoadExcels()">全部下载</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<!-- <a class="mini-button" iconCls="icon-upload2" onclick="doRepayImport()">补报批量导入</a> -->
