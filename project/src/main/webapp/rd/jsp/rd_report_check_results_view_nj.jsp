...
<title>南京校验结果详情</title>
<%@include file="../../common/quote/boot.html"%>
<script type="text/javascript">
	var HZbrNo = '${obj.organNo }' ;
	var HZreportDate = '${obj.reportDate}';
	var reportNoStr = '${obj.reportNoStr}';
	var formula = '${obj.formula}';
</script>
<script type="text/javascript" src="../js/rd_report_check_results_view_nj.js"></script>
</head>
<body>
	<table class="tab" cellpadding="4" cellspacing="0" style="width: 100%">
		...
		<tr>
			<td colspan="2" class="tab_align_c"><a class="mini-button" onclick="javascript:CloseWindow('cancel'),showTab()" style="width: 80px;">开始追溯</a></td>
			<td colspan="2" class="tab_align_c"><a class="mini-button" onclick="javascript:CloseWindow('cancel')" style="width: 80px;">关闭</a></td>
		</tr>
	</table>
</body>
</html>