...
<script type="text/javascript" src="${base }/dc/js/dcCheckResult.js"></script>
...
<c:if test="${dateformat =='1'}">
	...
	<div class="mini-fit">
		...
		<div id="checkDataGrid" multiSelect="true" class="mini-datagrid" url="${base}/dcCheck/result/getDcCheckResultWithLocalDB.nut?id=${param.id}&brNo=${param.brNo}&reportDate=${param.reportDate}"
