...
<script type="text/javascript" src="${base }/dc/js/dcCheckAll.js"></script>
...
<c:if test="${dateformat =='1'}">
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;">机构<input name="brNo" required="true" id="brNo" class="mini-treeselect" url="${base }/sys/bm/getSysBmListByUserId.nut" style="width: 240px;" parentField="pId"
                        ...
                        id="reportDate" class="mini-DatePicker" required="true" format="yyyy-MM-dd" style="width: 120px;"><span class="separator"></span> 表名称：
						...
						class="mini-combobox" url="${base}/sys/ggzd/getGgzdList.nut?groupId=DcCheckType" textField="zdName" valueField="zdValue" showClose="true" oncloseclick="onCloseClick" style="width: 100px;" /><a
	...
	<div class="mini-fit">
		<div id="checkGrid" class="mini-datagrid" style="width: 100%; height: 100%;" onrowdblclick="rowdblclick" url="${base}/dcCheck/all/getResultList.nut" pageSize="20" allowCellEdit="true" showPager="true"
			showModified="false">
			<div property="columns">
