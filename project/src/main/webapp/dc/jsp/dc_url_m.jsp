...
<script type="text/javascript" src="${base }/dc/js/dc_url_m.js"></script>
</head>
<body>
	<div style="width: 100%;">
	...
	<div class="mini-fit">
		<div id="formulaGrid" class="mini-datagrid" style="width: 100%; height: 100%;" url="${base}/dc/url/getDcUrlList.nut" pageSize="20" allowCellEdit="true" showPager="true" showModified="false">
			<div property="columns">
				...
				<div field="tableSchema" width="60" align="center" headerAlign="center">表模式名</div>
