...
<script type="text/javascript" src="../js/pi_create_report.js"></script>
...
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><label style="font-family: Verdana;">机构: </label> <input id="bmCode" name="brNo" style="width: 250px;" popupHeight="350px;" popupWidth="450px;" 
						class="mini-treeselect" url="${base }/sys/bm/getSysBmListByBmCategory.nut?bmCategory='PI'" textField="bmName" multiSelect="false" showFolderCheckBox="false" parentField="pId" valueField="bmCode" allowInput="false"
						...
						allowInput="false" /></div> &nbsp;&nbsp; <a class="mini-button" iconCls="icon-upload2" onclick="doCreateReport()">机构报文生成</a>  &nbsp;&nbsp; <a class="mini-button" iconCls="icon-upload2" onclick="doALLReport()">报送报文生成</a>
						</td>
				</tr>
			</table>
		</div>
	...
	<!--撑满页面-->
		<div class="mini-fit">
			<div id="bwjlGrid" class="mini-datagrid" style="width: 100%; height: 100%;" url="${base}/pi/cReport/getRecordList.nut" pageSize="20" showPager="true"
				showModified="false">
