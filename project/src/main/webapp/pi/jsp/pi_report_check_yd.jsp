...
<script type="text/javascript" src="../js/pi_report_check_yd.js"></script>
...
<body>
	<div id="reportCheckForm">
		<div class="mini-toolbar">
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><label style="font-family: Verdana;">上报地区: </label> <input id="bmCode" showClose="true" oncloseclick="onCloseClick"
						...
						url="${base }/sys/ggzd/getGgzdList.nut?groupId=PI_TABLE_TAB_TYPE" required="true" allowInput="false" />&nbsp;&nbsp;校验频度:&nbsp; <input id="reportRate" name="reportRate" class="mini-combobox" style="width: 80px;" textField="zdName" valueField="zdValue" 
						url="${base }/sys/ggzd/getGgzdList.nut?groupId=BF_YIDONG_FORMULA_TYPE" required="true"allowInput="false" />&nbsp;&nbsp;报表代码：&nbsp;<input id="tablecode"
						class="mini-textbox" style="width: 80px;" />&nbsp;&nbsp;指标代码：<input id="quotacode" class="mini-textbox" style="width: 100px;" />
						&nbsp;&nbsp;&nbsp;<a class="mini-button" iconCls="icon-ok" onclick="doReportCheck()">开始校验</a>
						&nbsp;&nbsp;&nbsp;<a class="mini-button" iconCls="icon-ok" onclick="search()">查询</a>
						&nbsp;&nbsp;&nbsp;<a class="mini-button" iconCls="icon-excel" onclick="doExportExcelSearch()">导出Excel</a>
	...
	<!--撑满页面-->
	<div class="mini-fit">
		<div id="reportCheckGrid" class="mini-datagrid" onrowdblclick="showCheckView" style="width: 100%; height: 100%" url="${base}/pi/check/wave/getRdReportCheckResults.nut" showPager="false"
			...
			<div property="columns">
				...
				<div field="quotaname" width="30" align="center" headerAlign="center">项目</div>
