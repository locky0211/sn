...
<script type="text/javascript" src="${base}/pi/js/pi_check_formula_wave.js"></script>
</head>
	...
	<form id="checkformulaForm" method="post">
		...
		<div>
			<table cellpadding="4" cellspacing="4" style="padding-left: 12px;">
				<tr>
					<td>报表代码：</td>
					<td colspan="3"><input id="tablecode" name="tablecode" class="mini-textbox" required="true" onchange="isincludSpace" style="width: 400px;"
						value="${obj.tablecode }" /></td>
				</tr>
				<tr>
					<td valign="top">指标代码：</td>
					<td colspan="3"><input id="quotacode" name="quotacode" required="true" class="mini-textarea"
						style="width: 400px; height: 50px;" value="${obj.quotacode }" /></td>
				</tr>
				<tr>
					<td valign="top">维度：</td>
					<td colspan="3"><input id="latcode" name="latcode" required="true" class="mini-textarea"
						style="width: 400px; height: 50px;" value="${obj.latcode }" /></td>
				</tr>
				<%-- <tr>
					<td>风险等级：</td>
