...
<script type="text/javascript" src="../js/pi_check_formula_wave_m.js"></script>
</head>
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><a class="mini-button" iconCls="icon-add" plain="true" onclick="addCheckFormula()">新增校验公式</a><span
						...
						class="mini-button" iconCls="icon-remove" plain="true" onclick="del()">删除</a> <span class="separator"></span>报表代码：<input id="tablecode"
						class="mini-textbox" style="width: 80px;" />&nbsp;&nbsp;指标代码：<input id="quotacode" class="mini-textbox" style="width: 100px;" />
						&nbsp;&nbsp;维度：<input id="latcode" class="mini-textbox" style="width: 100px;" />&nbsp;&nbsp;状态:&nbsp;
	...
	<div class="mini-fit">
		<div id="checkFormulaGrid" class="mini-datagrid" style="width: 100%; height: 100%;"
			...
			<div property="columns">
				...
				<div field="rate" width="20" align="center" allowSort="true" headerAlign="center" renderer="onRateRendeder">校验频度</div>
