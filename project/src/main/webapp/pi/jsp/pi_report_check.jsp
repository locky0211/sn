...
<script type="text/javascript" src="../js/pi_report_check.js"></script>
...
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><label style="font-family: Verdana;"> 上报地区: </label> <input id="bmCode" showClose="true" oncloseclick="onCloseClick"
						...
						url="${base }/sys/ggzd/getGgzdList.nut?groupId=PI_TABLE_TAB_TYPE" required="true" allowInput="false" />
	...
	<div class="mini-fit">
		<div id="reportCheckGrid" class="mini-datagrid" onrowdblclick="showCheckView" style="width: 100%; height: 100%"
			url="${base}/pi/check/getPiReportCheckResults.nut" showPager="false" onload="onGridLoad" allowAlternating="true" allowCellEdit="true" allowCellSelect="true">
