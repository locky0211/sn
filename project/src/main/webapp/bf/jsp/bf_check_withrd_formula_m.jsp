...
<script type="text/javascript" src="../js/bf_check_withrd_formula_m.js"></script>
</head>
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><a class="mini-button" iconCls="icon-add" plain="true" onclick="addCheckFormula()">新增校验公式</a><span
						...
						allowInput="false" />
						&nbsp;&nbsp;类型:&nbsp;
						<input id="formulaType" showNullItem="false" name="formulaType" textField="typeName" valueField="typeValue" class="mini-combobox" style="width: 80px;" data="[{typeValue:'M',typeName:'月度'},{typeValue:'S',typeName:'季度'},{typeValue:'Y',typeName:'年度'}]"
						allowInput="false" />
						&nbsp;&nbsp;
	...
	<div class="mini-fit">
		<div id="checkFormulaGrid" class="mini-datagrid" style="width: 100%; height: 100%;"
			url="${base}/bf/withRd/getFormulaList.nut" allowAlternating="true" pageSize="100" multiSelect="true"
			showModified="false">
