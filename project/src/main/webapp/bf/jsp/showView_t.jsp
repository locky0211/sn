...
<script type="text/javascript" src="../js/showView_t.js"></script>
</head>
<body>
...
<input id="reportDate" name="reportDate" class="mini-hidden" value="${param.reportDate}" />
	...
	<div class="mini-fit">
		<div id="showViewGrid" class="mini-datagrid"  style="width: 100%; height: 100%"
			url="${base}/bf/bfAuditSchedule/temp/showView.nut" showPager="false"  allowAlternating="true" onrowdblclick="showBfCheckResultView" >
