...
<script type="text/javascript" src="../js/bf_table_info_update_t.js"></script>
</head>
<body>
	<!--撑满页面-->
	<div class="mini-fit">
		<div id="tableInfoGrid"  allowAlternating="true"  borderStyle="border:0;" class="mini-datagrid" style="width: 100%; height: 100%"
			url="${base}/bf/table/temp/getTableInfoList.nut?tabCode=${param.tabCode}" showPager="false">
			<div property="columns">
				...
				<div field="tabType" width="40" align="center" headerAlign="center">报表类型</div>
