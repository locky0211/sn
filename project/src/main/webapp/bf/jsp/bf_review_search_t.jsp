...
<script type="text/javascript" src="../js/bf_review_search_t.js"></script>
...
<body>
	...
	<div class="mini-fit">
	<div id="remarksResultGrid" allowAlternating="true" class="mini-datagrid"  style="width: 100%; height: 100%;" url="${base}/bf/remarks/temp/getBfRemarksHistoryRecord.nut"
