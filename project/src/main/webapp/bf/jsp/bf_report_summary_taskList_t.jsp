...
<script type="text/javascript" src="../../bf/js/bf_report_summary_taskList_t.js"></script>
...
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td>
						...
						<input id="xnjg" name="xnjg" class="mini-hidden" value="${param.xnjg}"/>
	...
	<div class="mini-fit">
		<div id="reportSummaryGrid" class="mini-datagrid" multiSelect="true" onrowdblclick="showReportView" style="width: 100%; height: 100%"
			url="${base}/bf/report/Summary/temp/getBfTableInfoListByBrNo.nut" showPager="false"  allowAlternating="true" >
