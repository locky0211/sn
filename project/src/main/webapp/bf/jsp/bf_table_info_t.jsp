...
<script type="text/javascript" src="${base }/bf/js/bf_table_info_t.js"></script>
			...
			<table style="width: 100%" cellpadding="5">
				...
				<tr>
					...
					<td><input id="tabType" name="tabType" class="mini-combobox" style="width: 130px;" textField="zdName" valueField="zdValue"
						url="${base }/sys/ggzd/getGgzdList.nut?groupId=BF_TABLE_TAB_TYPE" required="true" allowInput="false" value="${tInfo.tabType}" /></td>
				</tr>
				<tr>
					<td>上报机构：</td>
					<td colspan="3"><input id="reportOrganTypes" name="reportOrganTypes" style="width: 370px;"  required="true"
						class="mini-treeselect" url="${base }/sys/bm/getSysBmListByUserIdDJZ.nut" textField="bmName" multiSelect="true" showFolderCheckBox="true" parentField="pId" valueField="bmCode" allowInput="false"
						onbeforenodeselect="beforenodeselect" resultAsTree="false"  popupHeight="300" showClose="true" oncloseclick="onCloseClick" expandOnLoad="true" checkRecursive="false" value="${tInfo.reportOrganTypes }" /></td>
				</tr>
			</table>
		</fieldset>
		<fieldset style="border: solid 1px #aaa;">
			...
			<table style="width: 100%" cellpadding="5">
				<tr>
					...
					<td><input id="versionNo" name="versionNo" class="mini-combobox" style="width: 120px;" textField="zdName" valueField="zdValue"
						url="${base }/sys/ggzd/getGgzdList.nut?groupId=BF_TABLE_VERSION_NO" required="true" allowInput="false" value="${tInfo.versionNo}" /></td>
				</tr>
				<tr>
					<td>启用日期：</td>
				...
				<tr>
					<td>报表统计信息：</td>
					<td><input id="rowSta" name="rowSta" class="mini-textbox" style="width: 360px;" required="true" value="${tInfo.rowSta}" /></td>
				</tr>
				<tr>
					<td>匹配关键字：</td>
				...
				<tr>
					<td>不变指标信息：</td>
					<td><input name="peculiar" class="mini-textarea" style="width: 360px;" value="${tInfo.peculiar}" /></td>
				</tr>
				<tr>
					<td>子报表名称：</td>
