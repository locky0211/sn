...
<script type="text/javascript" src="../js/bf_report_check_yd_checkWave_t.js"></script>
<%
...
<body>
	...
	<div class="mini-fit">
		<div id="reportCheckGrid" class="mini-datagrid" multiSelect="true" onrowdblclick="showCheckView" style="width: 100%; height: 100%" url="${base}/bf/check/wave/newCheck/temp/getRdReportCheckResultsNewList.nut"
