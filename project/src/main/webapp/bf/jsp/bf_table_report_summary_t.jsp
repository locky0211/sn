...
<%@ taglib prefix="rdr" uri="../tld/bf_table_report_summary.tld"%>
...
<script type="text/javascript" src="${base }/bf/js/bf_table_report_t.js"></script>
<title>报表数据页</title>
</head>
<body>
		...
		<div id="layout1" class="mini-layout" style="width: 100%; height: 100%;" splitSize="0">
			...
			<div title="center" region="center" style="border: 0;" bodyStyle="padding: 0px;">
				<form id="rdTableReportForm" action="">
					...
					<rdr:bfReportSummaryTag reportId="${reportId }" bjFlag="${bjFlag }"></rdr:bfReportSummaryTag>
				</form>
			</div>
		</div>
	</c:if>
