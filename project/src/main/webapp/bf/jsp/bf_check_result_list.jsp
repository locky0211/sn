...
<script type="text/javascript" src="../js/bf_check_result_list.js"></script>
...
<body>
	...
	<div class="mini-fit">
		<div id="checkResultGrid" allowAlternating="true" class="mini-datagrid" onrowclick="showCheckView" style="width: 100%; height: 100%;" url="${base}/bf/check/getBfReportCheckResultListArea.nut"
