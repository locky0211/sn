...
<script type="text/javascript" src="../js/bf_report_check_yd_t.js"></script>
...
<body>
	...
	<!--撑满页面-->
	<div class="mini-fit">
		<div id="reportCheckGrid" class="mini-datagrid" onrowdblclick="showCheckView" style="width: 100%; height: 100%" url="${base}/bf/check/wave/temp/getRdReportCheckResults.nut" showPager="false"
