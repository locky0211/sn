...
<script type="text/javascript" src="../js/bf_report_export_toIJ_wj.js"></script>
...
<body>
	...
	<!--撑满页面-->
		<div class="mini-fit">
			<div id="bwjlGrid" class="mini-datagrid" style="width: 100%; height: 100%;" url="${base}/bf/exportToIJ/getRecordList.nut" pageSize="20" showPager="true"
				showModified="false">
