...
<script type="text/javascript" src="../js/bf_valueChange_record.js"></script>
</head>
<body>
	<div style="width: 100%;">
	...
	<div class="mini-fit">
		<div id="valueChangeRecordGird" class="mini-datagrid" style="width: 100%; height: 100%;"
			url="${base}/bf/table/report/getValueChangeRecordList.nut?" allowAlternating="true" pageSize="100" multiSelect="true"
			showModified="false">
