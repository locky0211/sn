...
<script type="text/javascript" src="../js/bf_check_formula_m.js"></script>
</head>
<body>
	...
	<div class="mini-fit">
		<div id="checkFormulaGrid" class="mini-datagrid" style="width: 100%; height: 100%;"
			url="${base}/bf/check/getBfCheckFormulaList.nut?cUser=${param.cUser}" allowAlternating="true" pageSize="100" multiSelect="true"
			showModified="false">
