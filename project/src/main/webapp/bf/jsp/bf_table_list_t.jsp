...
<script type="text/javascript" src="../../bf/js/bf_table_list_t.js"></script>
</head>
<body>
	...
	<div class="mini-fit">
		<div id="tableListGrid" class="mini-datagrid" multiSelect="true" onrowdblclick="showReportView" style="width: 100%; height: 100%"
			url="${base}/bf/table/temp/getRdTableInfoListByReportDate.nut" showPager="false"  allowAlternating="true" >
