...
<script type="text/javascript" src="../js/bf_report_formula_m_t.js"></script>
</head>
<body>
	...
	<div class="mini-fit">
		<div id="checkFormulaGrid" class="mini-datagrid" style="width: 100%; height: 100%;"
			url="${base}/bf/report/temp/getBfCheckFormulaList.nut?cUser=${param.cUser}" allowAlternating="true" pageSize="100" multiSelect="true"
			showModified="false">
