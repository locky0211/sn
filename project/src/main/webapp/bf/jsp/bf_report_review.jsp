...
<%HttpSession Session = request.getSession();
  ...
  if(list.contains("5")){
	...
	%>
<script type="text/javascript" src="../js/bf_report_review.js"></script>
...
<body>
	...
	<div id="remarksResultGrid" allowAlternating="true" class="mini-datagrid" onrowdblclick="showCheckView" style="width: 100%; height: 100%;" url="${base}/bf/remarks/getBfReportRemarksResultListArea.nut"
