...
<script type="text/javascript" src="${base }/bf/js/bf_check_formula_import_t.js"></script>
</head>
	...
	<form id="importForm" method="post">
		<div>
			...
			<tr >
					...
					<td class="tab_field_nr tab_top "><input id="uploadExcel" class="mini-fileupload" name="file" limitType="*.xls;" flashUrl="${base }/common/js/miniui/swfupload/swfupload.swf" uploadUrl="${base}/bf/check/importExcecl.nut" uploadOnSelect="false" onuploadsuccess="onUploadSuccess" onuploaderror="onUploadError" onfileselect="onFileSelect" style="cursor: pointer; width: 180px;" /></td>
				</tr>
			</table>
		</div>
