...
<script type="text/javascript" src="${base }/bf/js/bf_check_formula_t.js"></script>
</head>
		...
		<div>
			<table cellpadding="4" cellspacing="4" style="padding-left: 12px;">
				...
				<tr>
					...
					<td>公式类型：</td>
					<td><input id="formulaType" name="formulaType" class="mini-combobox" required="true" style="width: 150px;" textField="zdName" valueField="zdValue" 
						url="${base }/sys/ggzd/getGgzdList.nut?groupId=BF_FORMULATYPE"   value="${obj.formulaType }" allowInput="false" /></td>
				</tr>
				<tr>
