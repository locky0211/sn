...
<script type="text/javascript" src="${base }/sam/js/rd_east_formula_available.js"></script>
</head>
<body>
	<div class="mini-fit">
		<div id="formulagrid" class="mini-datagrid" style="width: 100%; height: 100%;" url="${base}/sys/formulatype/getFormulaList.nut?row=${param.row}" pageSize="20" allowCellEdit="true" showPager="true" showModified="false">
			<div property="columns">
				...
				<div name="eastName" width="80" align="center" renderer="onNameRenderer_East" headerAlign="center">校验EAST报表名</div>
