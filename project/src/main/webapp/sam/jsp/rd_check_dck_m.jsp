...
<script type="text/javascript" src="${base }/sam/js/rd_check_dck_m.js"></script>
...
<body>
			...
			<table style="width: 100%;">
				<tr>
					...
					<label style="font-family: Verdana;">1104机构:&nbsp;</label><input id="rdBmcode" showClose="true" onvaluechanged="rdChange()" oncloseclick="onCloseClick"
						...
						class="mini-treeselect" url="${base }/sys/bm/getSysBmListByIsExistBmCategory.nut?bmCategory='DCK'"  textField="bmName" parentField="pId"
						valueField="bmCode" resultAsTree="false" allowInput="false" onbeforenodeselect="beforenodeselect" expandOnLoad="false"/>
	...
	<div class="mini-fit">
		<div id="checkGrid" class="mini-datagrid" style="width: 100%; height: 100%;" url="${base}/rd/check/dck/getCheckDckList.nut" onrowdblclick="rowdblclick" pageSize="20" allowCellEdit="true"
			...
			<div property="columns">
				...
				<div field="dckValue" width="35" align="center" headerAlign="center">客户风险数值</div>
				<div name="balance" width="35" align="center" headerAlign="center" renderer="onBalanceRenderer">数值差额</div>
				<div field="dckExplain" width="100" align="left" headerAlign="center">客户风险取数逻辑</div>
