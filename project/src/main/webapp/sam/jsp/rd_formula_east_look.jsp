...
<script type="text/javascript" src="${base }/sam/js/rd_formula_east_look.js"></script>
<script>
	var flagData = [ {
		id : '=',
		text : '1104等于EAST'
		...
		<table class="tab" style="width: 100%; height: 20px;" cellpadding="6" cellspacing="0">
			...
			<tr>
				...
				<td class="tab_field_nr" colspan="3"><div class="mini-combobox" url="${base}/sys/ggzd/getGgzdList.nut?groupId=EastTableName" textField="zdName" valueField="zdValue"
						oncloseclick="onCloseClick" showClose="true" readOnly="true" id="eastTableName" name="eastTableName" value="${obj.eastTableName}" popupWidth="50%" style="width: 100%">
			...
			<tr>
				...
				<td class="tab_field_nr" colspan="3" style="height: 100px;"><input class="mini-textarea" readOnly="true" id="eastContent" name="eastContent" value="${obj.eastContent}"
			...
			<tr>
				...
				<td class="tab_field_nr" colspan="3" style="height: 60px;"><input class="mini-textarea" id="eastExplain" name="eastExplain" readOnly="true" value="${obj.eastExplain}" style="width: 100%; height: 100%;" /></td>
				<td class="tab_label">取数公式解释</td>
			...
			<tr>
				...
				<td class="tab_field_nr" colspan="2" style="text-align: center"><input class="mini-combobox" id="formulaOp" readOnly="true"  name="formulaOp" data="flagData" value="${obj.formulaOp}" style="width: 98%" /></td>
				<td class="tab_label" colspan="2" style="text-align: center">校验公式类型</td>
				<td class="tab_field_nr" colspan="2" style="text-align: center"><input class="mini-combobox" id="formulaType" readOnly="true"  name="formulaType" data="formulaType" value="${obj.formulaType}"
					style="width: 98%" /></td>
			</tr>
			<tr>
