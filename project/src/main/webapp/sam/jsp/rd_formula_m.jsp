...
<script type="text/javascript" src="${base }/sam/js/rd_formula_m.js"></script>
</head>
<body>
	<div style="width: 100%;">
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;">客户风险表名称：
						<div id="dckTableName" class="mini-combobox" oncloseclick="onCloseClick" showClose="true" style="width: 180px;" popupWidth="600px" allowInput="true" url="${base}/sys/ggzd/getGgzdList.nut?groupId=DckImportTableName" textField="zdName" valueField="zdValue">
	...
	<div class="mini-fit">
		<div id="formulaGrid" class="mini-datagrid" style="width: 100%; height: 100%;" url="${base}/rd/formula/getFormulaList.nut" pageSize="20" allowCellEdit="true" showPager="true" showModified="false">
			<div property="columns">
				<div type="indexcolumn" align="center" width="15" headerAlign="center">序号</div>
				<div name="dspName" width="80" align="center" renderer="onDspNameRenderer" headerAlign="center">校验客户风险报表名</div>
