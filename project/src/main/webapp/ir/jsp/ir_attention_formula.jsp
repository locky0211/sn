...
<script type="text/javascript" src="../js/ir_attention_formula.js"></script>
</head>
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><a class="mini-button" iconCls="icon-add" plain="true" onclick="addCheckFormula()">新增校验公式</a><span
						...
						class="mini-button" iconCls="icon-remove" plain="true" onclick="del()">删除</a> <span class="separator"></span>报表编号：<input id="tabcode" class="mini-textbox" style="width: 80px;" />
						&nbsp;&nbsp;状态:&nbsp;
						<input id="vFlag" showNullItem="false" name="vFlag" class="mini-combobox" style="width: 80px;" data="[{id:'y',text:'启用'},{id:'n',text:'停用'}]"
						allowInput="false" />
						&nbsp;&nbsp;关注指标：<input id="check_formula" class="mini-textbox" style="width: 150px;" />
						&nbsp;&nbsp;
	...
	<div class="mini-fit">
		<div id="checkFormulaGrid" class="mini-datagrid" style="width: 100%; height: 100%;"
			url="${base}/ir/attention/getIrAttentionFormulaList.nut" allowAlternating="true" pageSize="100" multiSelect="true"
			showModified="false">
			<div property="columns">
				...
				<div field="tabcode" width="40" align="center" allowSort="true" headerAlign="center">报表编号</div>
				<div field="checkFormula" sortField="CHECK_FORMULA" autoEscape="true" align="center" allowSort="true" headerAlign="center">关注指标</div>
				...
				<div field="formulaExplain" sortField="FORMULA_EXPLAIN" autoEscape="true" align="center" allowSort="true" headerAlign="center">指标信息说明</div>
