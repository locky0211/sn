...
<script type="text/javascript" src="../js/ir_report_check.js"></script>
<script>
$(function() {
...
<body>
			...
			<table style="width: 100%;">
				<tr>                                <!-- url="${base }/sys/bm/getSysBmListByUserId.nut" -->
					<td style="width: 100%;"><label style="font-family: Verdana;"> 机构: </label> <input id="bmCode" showClose="true" oncloseclick="onCloseClick"
						...
						required="true" class="mini-treeselect" url="${base }/sys/bm/getSysBmListByIsExistBmCategory.nut?bmCategory='IR'" textField="bmName" multiSelect="false" parentField="pId"
						valueField="bmCode" resultAsTree="false" allowInput="false" onbeforenodeselect="beforenodeselect1" /> &nbsp;&nbsp;报表日期:&nbsp;<input id="rDate"
	...
	<div class="mini-fit">
		<div id="reportCheckGrid" class="mini-datagrid" onrowclick="showCheckView" style="width: 100%; height: 100%"
			url="${base}/ir/check/getIrReportCheckResults.nut" showPager="false" onload="onGridLoad" allowAlternating="true">
