...
<script type="text/javascript" src="../js/ir_check_formula.js"></script>
</head>
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><a class="mini-button" iconCls="icon-add" plain="true" onclick="addCheckFormula()">新增校验公式</a><span
						...
						allowInput="false" />
						&nbsp;&nbsp;类型:&nbsp;
						<input id="formulaAllType" showNullItem="false" name="formulaAllType" textField="typeName" valueField="typeValue" class="mini-combobox" style="width: 80px;" data="[{typeValue:'1',typeName:'普通'}]"
						allowInput="false" />
						&nbsp;&nbsp;
	...
	<div class="mini-fit">
		<div id="checkFormulaGrid" class="mini-datagrid" style="width: 100%; height: 100%;"
			url="${base}/ir/formula/getIrCheckFormulaList.nut" allowAlternating="true" pageSize="100" multiSelect="true"
			showModified="false">
			<div property="columns">
				...
				<div field="formulaAllType" width="10" renderer="onRenderType" align="center" headerAlign="center">类型</div>
