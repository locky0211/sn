...
<title>ir_table_info_m</title>
<%@include file="../../common/quote/boot.html"%>
<script type="text/javascript" src="../js/ir_table_info_m.js"></script>
</head>
<body>	
	...
	<!--撑满页面-->
	<div class="mini-fit">
		<div id="tableInfoGrid"  allowAlternating="true"  class="mini-datagrid" style="width: 100%; height: 100%" url="${base}/ir/table/getTableBasicInfoList.nut" showPager="false"
			showModified="false">
