...
<script type="text/javascript" src="${base }/dck/js/dspReportIn_m.js"></script>
...
<body>
	...
	<div class="mini-fit">
		<div id="bwjlGrid" class="mini-datagrid" style="width: 100%; height: 100%;" url="${base}/ckreport/getCKXmldrjlList.nut" pageSize="20" showPager="true" showModified="false">
