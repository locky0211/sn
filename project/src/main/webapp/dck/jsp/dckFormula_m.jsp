...
<script type="text/javascript" src="${base }/dck/js/dckFormula_m.js"></script>
<script>
	var flagData = [ {
		id : 1,
		text : '基础性校验'
...
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;">字段名称：<input id="fieldName" class="mini-textbox" style="width: 150px;" /><span class="separator"></span> 表名称：
						<div id="repCode" class="mini-combobox" oncloseclick="onCloseClick" showClose="true" style="width: 180px;" popupWidth="600px" allowInput="true" url="${base}/sys/ggzd/getGgzdList.nut?groupId=DckImportTableName" textField="zdName" valueField="zdValue">
							<div property="columns">
								<div header="表中文名称" field="zdName" width="80"></div>
								<div header="表数据库名称" field="zdValue" width="20"></div>
							</div>
						</div>
						</span> 公式类型：<input id="formulaType" class="mini-combobox" data="flagData" oncloseclick="onCloseClick" showClose="true" style="width: 150px;" /><span class="separator"></span>公式状态：<input id="formulaState" class="mini-combobox" url="${base}/sys/ggzd/getGgzdList.nut?groupId=formulaState" textField="zdName" valueField="zdValue"
	...
	<div class="mini-fit">
		<div id="formulaGrid" class="mini-datagrid" style="width: 100%; height: 100%;" url="${base}/dckformula/getFormulaList.nut" pageSize="20" allowCellEdit="true" showPager="true" showModified="false">
			<div property="columns">
				...
				<div field="formulaType" width="30" align="center" renderer="typeRenderer" headerAlign="center">公式类型</div>
