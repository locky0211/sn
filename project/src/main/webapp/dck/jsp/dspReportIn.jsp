...
<script type="text/javascript" src="${base }/dck/js/dspReportIn.js"></script>
			...
			<table class="tab" cellpadding="10" cellspacing="0">
				...
				<tr>
					...
					<td class="tab_field_nr "><input id="uploadExcel" required="true" class="mini-fileupload" name="file" limitType="*.zip;" flashUrl="${base }/common/js/miniui/swfupload/swfupload.swf"
						onuploadsuccess="onUploadSuccess" onuploaderror="onUploadError" onfileselect="onFileSelect" uploadUrl="${base }/ckreport/importXml.nut" uploadOnSelect="false"
