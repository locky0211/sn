...
<script type="text/javascript" src="${base }/dck/js/dsp_grkhxx_m.js"></script>
...
<body>
			...
			<table style="width: 100%;">
				<tr>
					...
					<!-- 	&nbsp;&nbsp;&nbsp;&nbsp;确定性校验结果：<input
						...
						&nbsp;&nbsp;贷款余额:<input id="dk" class="mini-combobox" data="flagDk" style="width: 120px;" /><a iconCls="icon-search" class="mini-button" plain="true"
	...
	<div class="mini-fit">
		<div id="grkhxxGrid" class="mini-datagrid" style="width: 100%; height: 100%;"
			url="${base}/grdkwy/getDspGrdkwyList.nut" pageSize="20" showPager="true" showModified="false">
			<div property="columns">
				...
				<div field="dkye" width="120" headerAlign="center">贷款余额</div>
