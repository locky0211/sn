...
<script type="text/javascript" src="${base }/dck/js/dckFormula.js"></script>
<script>
	var id = '${obj.id}'
	var flagData = [ {
		id : 1,
	...
	<form id="editForm">
		...
		<table class="tab" style="width: 100%; height: 20px;" cellpadding="6" cellspacing="0">
			<tr>
				...
				<td class="tab_field_nr" style="width: 38%"><div class="mini-combobox" url="${base}/sys/ggzd/getGgzdList.nut?groupId=DckImportTableName" textField="zdName" valueField="zdValue"
						oncloseclick="onCloseClick" showClose="true" required="true" id="repCode" name="repCode" value="${obj.repCode}" popupWidth="85%" style="width: 98%">
						<div property="columns">
							<div header="表中文名称" field="zdName" width="85"></div>
							<div header="表数据库名称" field="zdValue" width="15"></div>
						</div>
					</div></td>
				<td class="tab_label" style="width: 12%">公式类型</td>
				<td class="tab_field_nr" style="width: 38%"><input class="mini-combobox" id="formulaType" name="formulaType" data="flagData" value="${obj.formulaType}" style="width: 98%" /></td>
			</tr>
			<tr>
