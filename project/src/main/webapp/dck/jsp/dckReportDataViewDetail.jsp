...
<script type="text/javascript">
	...
	var tableName = '${requestScope.DckReportTableName}';
	var fieldName = '${requestScope.DckReportFieldName}';
	var dataId = '${requestScope.DckReportTableDataId}';
</script>
<script type="text/javascript" src="${base }/dck/js/dckReportDataViewDetail.js"></script>
</head>
				...
				<c:forEach items="${obj.data }" var="pair">
					<tr>
						...
						<td class="tab_field_nr" colspan="3">
							<c:if test="${pair.code1 == requestScope.DckReportFieldName}">
						...
						<td class="tab_field_nr" colspan="3">
							<c:if test="${pair.code2 == requestScope.DckReportFieldName}">
