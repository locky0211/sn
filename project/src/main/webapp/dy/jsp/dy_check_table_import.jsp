...
<script type="text/javascript" src="${base }/dy/js/dy_check_table_import.js"></script>
</head>
<body>
	<div class="mini-fit">
		<div id="checkTableImportGrid" class="mini-datagrid" style="width: 100%; height: 100%;" borderStyle="border: 0; padding: 0px;"
			url="${base}/dy/check/getCheckTableImport.nut?brNo=${param.brNo}&tabType=${param.tabType}&reportDate=${param.reportDate}" allowAlternating="true"
			showPager="false">
