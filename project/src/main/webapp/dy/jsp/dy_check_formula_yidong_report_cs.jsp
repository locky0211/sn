...
<script type="text/javascript" src="../js/dy_check_formula_yidong_report_cs.js"></script>
</head>
<body>
	...
	<!--撑满页面-->
	<div class="mini-fit">
		<div id="YidongFormulaReportGrid" class="mini-datagrid" multiSelect="true" onrowdblclick="showReportView" style="width: 100%; height: 100%" url="${base}/dy/table/getCheckFormulaYidongReport.nut" showPager="false" allowAlternating="true">
