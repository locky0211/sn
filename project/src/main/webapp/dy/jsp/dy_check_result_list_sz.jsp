...
<script type="text/javascript" src="../js/dy_check_result_list_sz.js"></script>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><label style="font-family: Verdana;"> 机构: </label> <input id="bmCode" showClose="true" oncloseclick="onCloseClick" name="brNo" style="width: 250px;"
						...
						/> &nbsp;&nbsp;报表日期:&nbsp;<input id="rDate" name="reportDate" style="width: 90px;" class="mini-monthpicker" format="yyyyMM" required="true" value="${param.reportDate }" />
						...
						url="${base }/sys/ggzd/getGgzdList.nut?groupId=DY_TABLE_TAB_TYPE" allowInput="false" /> <input id="checkType" name="checkType" showNullItem="true" class="mini-hidden" style="width: 60px;"
