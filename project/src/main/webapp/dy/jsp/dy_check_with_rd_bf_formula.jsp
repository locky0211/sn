...
<script type="text/javascript" src="../js/dy_check_with_rd_bf_formula.js"></script>
</head>
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><a class="mini-button" iconCls="icon-add" plain="true" onclick="addCheckFormula()">新增校验公式</a><span
						...
						&nbsp;&nbsp;状态:&nbsp;
						<input id="validFlag" showNullItem="false" name="validFlag" class="mini-combobox" style="width: 80px;" data="[{id:'y',text:'启用'},{id:'n',text:'停用'}]"
						allowInput="false" />
	...
	<div class="mini-fit">
		<div id="checkFormulaGrid" class="mini-datagrid" style="width: 100%; height: 100%;"
			url="${base}/dy/checkRdBf/getDyCheckFormulaList.nut" allowAlternating="true" pageSize="100" multiSelect="true"
			showModified="false">
			<div property="columns">
				...
				<div field="checkFormula" width="75" sortField="CHECK_FORMULA" autoEscape="true" align="center" allowSort="true" headerAlign="center">校验公式</div>
				<div field="formulaExplain"  width="75" sortField="FORMULA_EXPLAIN" autoEscape="true" align="center" allowSort="true" headerAlign="center">公式解释</div>
				...
				<div field="formulaType" width="15" renderer="onRenderType" align="center" headerAlign="center" >公式类型</div>
				<div width="15" renderer="onRenderer" align="center" headerAlign="center">操作</div>
			</div>
		</div>
	</div>
</body>
