...
<%@ taglib prefix="rdr" uri="../tld/table_report_formula_cs.tld"%>
...
<script type="text/javascript" src="${base }/dy/js/dy_table_report_formula_cs.js"></script>
<title>报表数据页</title>
</head>
		...
		<div id="layout1" class="mini-layout" style="width: 100%; height: 100%;" splitSize="0">
			<div title="center" region="center" style="border: 0;" bodyStyle="padding: 0px;">
				<form id="rdTableReportForm" action="">
					...
					<rdr:rdReportFormulaCSTag tableId="${tableInfo.tableId }"></rdr:rdReportFormulaCSTag>
				</form>
			</div>
		</div>
	</c:if>
