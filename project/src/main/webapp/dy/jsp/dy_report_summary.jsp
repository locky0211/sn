...
<script type="text/javascript" src="../js/dy_report_summary.js"></script>
</head>
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><label style="font-family: Verdana;">机构: </label> <input id="bmCode" name="brNo" style="width: 250px;"
						popupHeight="350px;" popupWidth="450px;" required="true" class="mini-treeselect" url="${base }/sys/bm/getSysBmListByIsExistBmCategory.nut?bmCategory='DY'"
						...
						url="${base }/sys/ggzd/getGgzdList.nut?groupId=DY_TABLE_TAB_TYPE" required="true" allowInput="false" onvaluechanged="gridLoad()" />
	...
	<div class="mini-fit">
		<div id="reportImportGrid" class="mini-datagrid" multiSelect="true" onrowdblclick="showReportView" style="width: 100%; height: 100%"
			url="${base}/dy/report/Summary/getDyTableInfoListByBrNo.nut" showPager="false"  allowAlternating="true" >
