...
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;">&nbsp;&nbsp;报表日期:&nbsp;<input id="reportDate" name="reportDate" style="width: 80px;" class="mini-monthpicker"
						...
						style="width: 80px;" textField="zdName" valueField="zdValue" url="${base }/sys/ggzd/getGgzdList.nut?groupId=DY_TABLE_TAB_TYPE" required="true"
	...
	<!--撑满页面-->
	<div class="mini-fit">
		<div id="checkLogGrid" class="mini-datagrid"  allowAlternating="true"  style="width: 100%; height: 100%" url="${base}/dy/check/log/getDyReportCheckLog.nut" showPager="false">
