...
<script type="text/javascript" src="../js/dy_check_formula_wave_m_cs.js"></script>
</head>
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><a class="mini-button" iconCls="icon-add" plain="true" onclick="addCheckFormula()">新增校验公式</a><span
						...
						&nbsp;&nbsp;<a class="mini-button" iconCls="icon-excel" onclick="showTab('DY.DY_CHECK_FORMULA_WAVE_AUTO','异动公式批量导入','dy/jsp/dy_check_formula_yidong_report_cs.jsp')">批量导入</a></td>
				</tr>
			</table>
		</div>
	</div>
	<div class="mini-fit">
		<div id="checkFormulaGrid" class="mini-datagrid" style="width: 100%; height: 100%;"
			url="${base}/dy/check/wave/getDyCheckFormulaWaveList.nut" allowAlternating="true" pageSize="100" multiSelect="true"
			showModified="false">
