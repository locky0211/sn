...
<script type="text/javascript" src="../js/dy_report_check_repay.js"></script>
<script>
$(function() {
...
<body>
	...
	<div class="mini-fit">
		<div id="reportCheckGrid" class="mini-datagrid" onrowclick="showCheckView" style="width: 100%; height: 100%"
			url="${base}/dy/check/getDyReportCheckResultsRepay.nut" showPager="false" onload="onGridLoad" allowAlternating="true">
