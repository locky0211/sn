...
<script type="text/javascript" src="${base}/dy/js/dy_check_formula_wave_cs.js"></script>
</head>
			...
			<table cellpadding="4" cellspacing="4" style="padding-left: 12px;">
				...
				<tr>
					...
					<td><input id="thisVersion" name="thisVersion" style="width: 150px;" showClose="true" oncloseclick="onCloseClick"
						class="mini-combobox" url="${base }/dy/table/getTableVersionNo.nut?tabCode=${obj.tabcode }" textField="versionNo" multiSelect="false" 
