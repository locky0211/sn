...
<%@ taglib prefix="rdr" uri="../tld/table_report_sz.tld"%>
...
<script type="text/javascript" src="${base }/dy/js/dy_table_report.js"></script>
<%-- <c:if test="${tableInfo!=null}">
	<script type="text/javascript" src="${base }/dy/autojs/${tableInfo.tabCode }_${tableInfo.versionNo }.js"></script>
</c:if> --%>
<title>报表数据页</title>
</head>
		...
		<div id="layout1" class="mini-layout" style="width: 100%; height: 100%;" splitSize="0">
			...
			<div title="center" region="center" style="border: 0;" bodyStyle="padding: 0px;">
				<form id="rdTableReportForm" action="">
					...
					<rdr:dyReportTagSZ reportId="${reportId }" bjFlag="${bjFlag }"></rdr:dyReportTagSZ>
				</form>
			</div>
