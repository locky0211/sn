...
<script type="text/javascript" src="../js/dy_check_report.js"></script>
</head>
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;">报表日期:&nbsp;<input id="rDate" name="reportDate" style="width: 80px;" class="mini-monthpicker" format="yyyyMM"
						...
						style="width: 60px;" textField="zdName" valueField="zdValue" url="${base }/sys/ggzd/getGgzdList.nut?groupId=DY_TABLE_TAB_TYPE" required="true"
	...
	<div class="mini-fit">
		<div id="checkReportGrid" class="mini-datagrid" style="width: 100%; height: 100%;" url="${base}/dy/check/getCheckReport.nut" allowAlternating="true"
			showPager="false">
