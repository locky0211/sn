...
<title>报表数据校验(苏州)</title>
<%@include file="../../common/quote/boot.html"%>
<script type="text/javascript" src="../js/dy_report_check_old_sz.js"></script>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><label style="font-family: Verdana;"> 机构: </label> <input id="bmCode" showClose="true" oncloseclick="onCloseClick"
						...
						name="reportDate" style="width: 90px;" class="mini-monthpicker" format="yyyyMM" required="true" />
