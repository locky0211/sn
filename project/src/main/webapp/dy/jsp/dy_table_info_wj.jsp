...
<script type="text/javascript" src="../js/dy_table_info_wj.js"></script>
</head>
	...
	<form id="tableInfoForm" method="post">
			...
			<table style="width: 100%" cellpadding="5">
				...
				<tr>
					...
					<td><input id="tabType" name="tabType" class="mini-combobox" style="width: 130px;" textField="zdName" valueField="zdValue"
						url="${base }/sys/ggzd/getGgzdList.nut?groupId=DY_TABLE_TAB_TYPE_WJ" required="true" allowInput="false" value="${tInfo.tabType}" /></td>
					<%-- <td>报送类型：</td>
					<td><input id="tabBrType" name="tabBrType" class="mini-combobox" style="width: 115px;" data="[{id:'法人分支',text:'法人分支'}]" emptyText="请选择"
				...
				<tr>
					...
					<td colspan="3"><input id="reportOrganTypes" name="reportOrganTypes" style="width: 370px;" showClose="true" required="true" oncloseclick="onCloseClick"
						class="mini-treeselect" url="${base }/sys/ggzd/getGgzdList.nut?groupId=SYS_YGBMGL" textField="zdName" multiSelect="true" parentField="pId"
		...
		<fieldset style="border: solid 1px #aaa;">
			...
			<table style="width: 100%" cellpadding="5">
				...
				<tr>
					<td>Excel模板文件：</td>
					<td><input style="width: 360px;" uploadUrl="${base }/upload/uploadFile.nut" class="mini-fileupload" name="file" limitType="*.xls;*.xlsx"
