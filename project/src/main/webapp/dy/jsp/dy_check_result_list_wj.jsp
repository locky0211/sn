...
<script type="text/javascript" src="../js/dy_check_result_list_wj.js"></script>
...
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><label style="font-family: Verdana;"> 机构: </label> <input id="bmCode" showClose="true" oncloseclick="onCloseClick" name="brNo" style="width: 250px;"
						popupHeight="300px;" popupWidth="350px;" multiSelect="true" showFolderCheckBox="true" checkRecursive="true" required="true" class="mini-treeselect" url="${base }/sys/bm/getSysBmListByIsExistBmCategory.nut?bmCategory='DY'"
						...
						/> &nbsp;&nbsp;报表日期:&nbsp;<input id="rDate" name="reportDate" style="width: 90px;" class="mini-datepicker" format="yyyyMMdd" required="true" value="${param.reportDate }" />
						...
						url="${base }/sys/ggzd/getGgzdList.nut?groupId=DY_TABLE_TAB_TYPE_WJ" allowInput="false" /> <input id="checkType" name="checkType" showNullItem="true" class="mini-hidden" style="width: 60px;"
						...
						class="mini-combobox" style="width: 80px;" textField="zdName" showNullItem="true" valueField="zdValue" value="${param.checkRisk }" url="${base }/sys/ggzd/getGgzdList.nut?groupId=DY_CHECK_RISK"
	...
	<div class="mini-fit">
		<div id="checkResultGrid" allowAlternating="true" class="mini-datagrid" onrowclick="showCheckView" style="width: 100%; height: 100%;" url="${base}/dy/check/getDyReportCheckResultListArea.nut"
