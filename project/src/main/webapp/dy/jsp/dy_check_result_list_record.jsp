...
<script type="text/javascript" src="../js/dy_check_result_list_record.js"></script>
</head>
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><label style="font-family: Verdana;"> 机构: </label> <input id="bmCode" showClose="true" oncloseclick="onCloseClick"
						...
						url="${base }/sys/ggzd/getGgzdList.nut?groupId=DY_TABLE_TAB_TYPE" allowInput="false" />&nbsp;&nbsp;风险等级:&nbsp; <input id="checkRisk" name="checkRisk"
						class="mini-combobox" style="width: 80px;" textField="zdName" showNullItem="true" valueField="zdValue" value="${param.checkRisk }"
						url="${base }/sys/ggzd/getGgzdList.nut?groupId=DY_CHECK_RISK" allowInput="false" /> &nbsp;&nbsp; <a class="mini-button" iconCls="icon-search"
	...
	<div class="mini-fit">
		<div id="checkResultGrid" allowAlternating="true" class="mini-datagrid" onrowclick="showCheckView" style="width: 100%; height: 100%;"
			url="${base}/dy/check/getDyReportCheckResultListRecord.nut" pageSize="150" allowAlternating="true" showPager="true" showModified="false">
