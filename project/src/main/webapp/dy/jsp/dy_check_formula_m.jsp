...
<title>校验公式信息维护<a class="mini-button" iconCls="icon-search" onclick="search()">查询</a></title>
...
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><a class="mini-button" iconCls="icon-add" plain="true" onclick="addCheckFormula()">新增校验公式</a><span
						...
						allowInput="false" />
						&nbsp;&nbsp;类型:&nbsp;
						<input id="formulaType" showNullItem="false" name="formulaType" textField="typeName" valueField="typeValue" class="mini-combobox" style="width: 80px;" data="[{typeValue:'1',typeName:'普通'}]"
						allowInput="false" />
						&nbsp;&nbsp;
	...
	<div class="mini-fit">
		<div id="checkFormulaGrid" class="mini-datagrid" style="width: 100%; height: 100%;"
			url="${base}/dy/check/getDyCheckFormulaList.nut?cUser=${param.cUser}" allowAlternating="true" pageSize="100" multiSelect="true"
			showModified="false">
