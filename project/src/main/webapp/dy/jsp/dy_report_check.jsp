...
<script type="text/javascript" src="../js/dy_report_check.js"></script>
<script>
	$(function() {
...
<body>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;"><label style="font-family: Verdana;"> 机构: </label> <input id="bmCode" showClose="true" oncloseclick="onCloseClick" name="brNo" style="width: 250px;"
						...
						name="tabType" class="mini-combobox" style="width: 80px;" textField="zdName" valueField="zdValue" url="${base }/sys/ggzd/getGgzdList.nut?groupId=DY_TABLE_TAB_TYPE" required="true"
						allowInput="false" /> <input id="formulaType" class="mini-hidden" showNullItem="false" name="formulaType" textField="typeName" valueField="typeValue" class="mini-combobox" style="width: 100px;"
						data="[{typeValue:'2',typeName:'异动'}]" allowInput="false" /> <!-- <div id="isRepay" name="isRepay" class="mini-checkbox" readOnly="false" text="校验补报数据"></div> &nbsp;&nbsp; --> <a
						class="mini-button" iconCls="icon-ok" onclick="doReportCheck()">开始校验</a>&nbsp;&nbsp;&nbsp;<a class="mini-button" iconCls="icon-excel" onclick="doExportExcel()">导出Excel</a></td>
				</tr>
				<tr>
	...
	<!--撑满页面-->
	<div class="mini-fit">
		<div id="reportCheckGrid" class="mini-datagrid" onrowclick="showCheckView" style="width: 100%; height: 100%" url="${base}/dy/check/getDyReportCheckResultsYidong.nut" showPager="false"
			onload="onGridLoad" allowAlternating="false">
			<div property="columns">
				...
				<div field="formulaModel" autoEscape="true" width="40" headerAlign="center" align="center">公式</div>
				<div field="reportRate" autoEscape="true" width="40" headerAlign="center" align="center">频度</div>
				<div field="valueArea" autoEscape="true" width="40" headerAlign="center" align="center">阈值</div>
				<div field="content" autoEscape="true" width="40" headerAlign="center" align="center">公式结果</div>
