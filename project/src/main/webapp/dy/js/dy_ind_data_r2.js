...
function doExportIndDataExcel() {
	...
	if (form.isValid() && checkDate()) {
		...
		$.ajax({
					url : base + 'dy/ind/data/report/doExportIndDataExcel2.nut',
					type : 'post',
					dataType : 'json',
					data : {
...
function doInItDataExcel() {
	...
	$.ajax({
				url : base + 'dy/ind/data/report/initIndDataExcel2.nut',
				type : 'post',
				dataType : 'json',
				cache : false,
				data : {
...
function doInItDataPie() {
	...
	$.ajax({
				url : base + 'dy/ind/data/report/initIndDataReport2.nut',
				type : 'post',
				dataType : 'json',
				cache : false,
				data : {
