...
function toNoCheckView(areaCode) {
	mini.open({
				url : base + "dy/jsp/dy_no_check.jsp?areaCode=" + areaCode + "&reportDate=" + mini.get('reportDate').getFormValue() + "&tabType="
...
function toNoPassView(areaCode, checkRisk) {
	...
	mini.open({
				url : base + "dy/jsp/dy_no_pass.jsp?areaCode=" + areaCode + "&reportDate=" + mini.get('reportDate').getFormValue() + "&tabType="
