...
function add(){
	...
	if(form.isValid()&&checkIsNumber()){
		...
		$.ajax({
					url : base + 'dy/check/wave/autoAddFormulaYidongVersionCS.nut?jsonstr='+jsonstr+'&tabCode='+tabCode+'&checkRisk='+checkRisk+'&reportRate='+reportRate+'&leftValue='+leftValue+'&rightValue='+rightValue+'&thisVersion='+thisVersion+'&lastVersion='+lastVersion+'&cUser='+cUser+'&elementNew='+elementNew,
					type : 'post',
					dataType : 'json',
					cache : false,
