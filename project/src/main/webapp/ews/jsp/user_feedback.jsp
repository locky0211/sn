...
<script type="text/javascript" src="${base }/ews/js/user_feedback.js"></script>
<title>公告信息</title>
</head>
<body style="overflow: auto;">
	<form id="sysNoticeForm" method="post">
		...
		<table style="width: 100%" cellpadding="5" cellspacing="0">
			...
			<tr>
				<td class="tab_label" valign="top" style="text-align: right;">反馈内容：</td>
				<td class="tab_field_nr"><textarea id="content" name="content" style="width: 500px; height: 110px;" >${obj.content }</textarea></td>
			</tr>
		</table>
