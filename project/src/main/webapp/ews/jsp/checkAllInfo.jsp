...
<script type="text/javascript" src="${base }/ews/js/checkAllInfo.js"></script>
...
<c:if test="${dateformat =='1'}">
	...
	<div class="mini-fit">
		<div id="checkGrid" class="mini-datagrid" style="width: 100%; height: 100%;"  onrowdblclick="rowdblclick" url="${base}/check/allInfo/getCheckAllInfo.nut?brNo=${param.brNo}&reportDate=${param.reportDate}" pageSize="10" allowCellEdit="true" showPager="true"
	...
	<div id="checkTempGrid" class="mini-datagrid" style="width: 100%; height: 40%;" url="${base}/check/allInfo/getCheckBrTemp.nut" pageSize="10" allowCellEdit="true" showPager="true"
