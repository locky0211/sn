...
<script type="text/javascript" src="${base }/ews/js/checkFormula_sls_zdy.js"></script>
</head>
<body>
	<div style="width: 100%;">
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;">字段名称：<input id="fieldName" class="mini-textbox" style="width: 150px;" /><span class="separator"></span> 表名称：
						...
						</div> <span class="separator"></span> 公式类型：<input id="formulaType" class="mini-combobox" url="${base}/sys/ggzd/getGgzdList.nut?groupId=CheckType" textField="zdName" valueField="zdValue"
						...
						公式版本：<input id="version" class="mini-combobox" url="${base}/sys/ggzd/getGgzdList.nut?groupId=CheckVersion" textField="zdName" valueField="zdValue" showClose="true" oncloseclick="onCloseClick" style="width: 100px;" />
						 <a iconCls="icon-search" class="mini-button" plain="true" onclick="search()">查询</a> <a
	...
	<div class="mini-fit">
		<div id="formulaGrid" class="mini-datagrid" style="width: 100%; height: 100%;" url="${base}/formula/sls/zdy/getFormulaList.nut" pageSize="20" allowCellEdit="true" showPager="true" showModified="false">
			<div property="columns">
				...
				<div field="version" width="40" renderer="onVersionNameRenderer" headerAlign="center" align="center">公式版本</div>  
