...
<script type="text/javascript" src="${base }/ews/js/checkNotNull.js"></script>
...
<c:if test="${dateformat =='1'}">
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;">机构:<input name="brNo" required="true" id="brNo" class="mini-treeselect" url="${base }/sys/bm/getSysBmListByIsExistBmCategory.nut?bmCategory='EAST'" style="width: 240px;" parentField="pId"
						...
						公式版本：<input id="version" class="mini-combobox" required="true" url="${base}/sys/ggzd/getGgzdList.nut?groupId=CheckVersion" textField="zdName" valueField="zdValue" showClose="true" oncloseclick="onCloseClick" style="width: 80px;" />
						...
						<span class="separator"></span>
						校验类型：<input id="checkType" class="mini-combobox" url="${base}/sys/ggzd/getGgzdList.nut?groupId=checkType" textField="zdName" valueField="zdValue"
	...
	<div class="mini-fit">
		<div id="checkGrid" class="mini-datagrid" style="width: 100%; height: 100%;" onrowdblclick="rowdblclick" url="${base}/check/notnull/getResultList.nut" pageSize="20" allowCellEdit="true"
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;">机构:<input name="brNo" required="true" id="brNo" class="mini-treeselect" url="${base }/sys/bm/getSysBmListByUserId.nut" style="width: 240px;" parentField="pId"
						...
						id="endDate" class="mini-DatePicker" required="true" format="yyyy-MM-dd" style="width: 120px;">
						 <span class="separator"></span>
						公式版本：<input id="version" required="true" class="mini-combobox" url="${base}/sys/ggzd/getGgzdList.nut?groupId=CheckVersion" textField="zdName" valueField="zdValue" showClose="true" oncloseclick="onCloseClick" style="width: 100px;" />
						<span class="separator"></span> 表名称：
						<div id="repCode" class="mini-combobox" oncloseclick="onCloseClick" showClose="true" style="width: 180px;" popupWidth="350px" allowInput="true"
							url="${base}/sys/ggzd/getGgzdList.nut?groupId=EastTableName" textField="zdName" valueField="zdValue">
							<div property="columns">
						...
						<span class="separator"></span>公式状态：<input id="checkType" class="mini-combobox" url="${base}/sys/ggzd/getGgzdList.nut?groupId=checkType" textField="zdName" valueField="zdValue"
						oncloseclick="onCloseClick" showClose="true" style="width: 100px;" />
						<span class="separator"></span><a iconCls="icon-search" class="mini-button" plain="true"
	...
	<div class="mini-fit">
		<div id="checkGrid" class="mini-datagrid" style="width: 100%; height: 100%;" onrowdblclick="rowdblclick_sd" url="${base}/check/notnullsd/getResultList.nut" pageSize="20" allowCellEdit="true"
			showPager="true" showModified="false">
			<div property="columns">
				<div type="indexcolumn" align="center" width="15" headerAlign="center">序号</div>
				<div name="zd_name" width="70" align="center" renderer="onNameRenderer" headerAlign="center">错误表名</div>
