...
<script type="text/javascript" src="${base }/ews/js/scoreResult_sj.js"></script>
<%
...
<body>
	<div style="width: 100%;"id="scoreForm">
		<div class="mini-toolbar" style="border-bottom: 0; padding: 0px;">
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;">机构<input name="brNo" required="true" id="brNo" class="mini-treeselect" url="${base }/sys/bm/getSysBmListByIsExistBmCategory.nut?bmCategory='EAST'" style="width: 240px;" checkRecursive="true" parentField="pId"
					...
					<!-- 	&nbsp;&nbsp;<a class="mini-button" iconCls="icon-add" plain="true" onclick="onin()">导入打分明细</a>
						&nbsp;&nbsp;<a class="mini-button" iconCls="icon-add" plain="true" onclick="onin()">导入科融校验结果明细</a> -->
				</tr>
			</table>
		</div>
	</div>
	<div class="mini-fit">
		...
		imgPath="${base }/common/js/miniui/themes/icons/" url="${base}/sjscore/result/getSelectList.nut" allowAlternating="true">
