...
<c:if test="${dateformat =='1'}">
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;">机构<input name="brNo" required="true" id="brNo" class="mini-treeselect" url="${base }/sys/bm/getSysBmListByUserIdForRd.nut" style="width: 240px;" parentField="pId"
						...
						iconCls="icon-search" class="mini-button" plain="true" onclick="search()">查询</a>&nbsp;&nbsp;&nbsp;
	...
	<div class="mini-fit">
		<div id="checkGrid" class="mini-datagrid" style="width: 100%; height: 100%;" onrowdblclick="rowdblclick" url="${base}/check/all/getResultListOrderByTableNumber.nut" pageSize="20" allowCellEdit="true" showPager="true"
			showModified="false">
			<div property="columns">
				<div type="indexcolumn" align="center" width="15" headerAlign="center">序号</div>
				<div field="tableNumber" width="15" align="center" headerAlign="center">表号</div>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;">机构<input name="brNo" required="true" id="brNo" class="mini-treeselect" url="${base }/sys/bm/getSysBmListByUserId.nut" style="width: 240px;" parentField="pId"
						...
						class="mini-combobox" url="${base}/sys/ggzd/getGgzdList.nut?groupId=CheckType" textField="zdName" valueField="zdValue" showClose="true" oncloseclick="onCloseClick" style="width: 100px;" /><a
						iconCls="icon-search" class="mini-button" plain="true" onclick="search_sd()">查询</a>&nbsp;&nbsp;
