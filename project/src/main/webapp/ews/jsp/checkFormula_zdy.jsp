...
<script type="text/javascript" src="${base }/ews/js/checkFormula_zdy.js"></script>
<script>
	var id = '${obj.id}'
</script>
</head>
<body>
	...
	<div style="text-align: center;">
		<a class="mini-button" onclick="onSave" style="width: 70px; margin-right: 10px;" iconCls="icon-ok">确定</a> <a class="mini-button" onclick="onCancel" style="width: 60px; margin-right: 10px;">取消</a>
