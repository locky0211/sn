...
<script type="text/javascript" src="${base }/ews/js/checkFormula_m.js"></script>
</head>
<body>
	<div style="width: 100%;">
	...
	<div class="mini-fit">
		<div id="formulaGrid" class="mini-datagrid" style="width: 100%; height: 100%;" url="${base}/formula/getFormulaList.nut" pageSize="20" allowCellEdit="true" showPager="true" showModified="false">
			<div property="columns">
