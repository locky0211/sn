...
<script type="text/javascript" src="${base }/ews/js/scoreFormula_sj_m.js"></script>
</head>
<body>
	<div style="width: 100%;">
	...
	<div class="mini-fit">
		...
		imgPath="${base }/common/js/miniui/themes/icons/" url="${base}/sjscore/formula/getSelectList.nut" allowAlternating="true">
			<div property="columns">
				...
				<div field="formula" width="130" align="center" headerAlign="center">公式</div>
				<div field="scoreStandard" width="70" align="center" headerAlign="center">打分标准</div>
