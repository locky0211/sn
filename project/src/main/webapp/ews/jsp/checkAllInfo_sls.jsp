...
<script type="text/javascript" src="${base }/ews/js/checkAllInfo_sls.js"></script>
...
<c:if test="${dateformat =='1'}">
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;">机构：<input name="brNo" required="true" id="brNo" class="mini-treeselect" url="${base }/sys/bm/getSysBmListByIsExistBmCategory.nut?bmCategory='EAST'" style="width: 300px;" parentField="pId"
						...
						<a iconCls="icon-goto" class="mini-button" plain="true" onclick="addCheck()">添加校验</a>&nbsp;&nbsp;&nbsp;<a iconCls="icon-goto" class="mini-button" plain="true" onclick="addAllCheck()">一键校验</a>
				</tr>
			</table>
		</div>
	</div>
	...
	<div class="mini-fit">
		<div id="checkGrid" class="mini-datagrid" style="width: 100%; height: 100%;"  onrowdblclick="rowdblclick" url="${base}/check/allInfoSls/getCheckAllInfo.nut?brNo=${param.brNo}&reportDate=${param.reportDate}" pageSize="10" allowCellEdit="true" showPager="true"
	 ...
	 <div id="checkFormula_Form" style="display:none;">
        <div id="checkFormula_grid" class="mini-datagrid" style="width:100%;height:200px;" 
            url="${base}/check/allInfoSls/getCheckFormulaById.nut" showPager="false">
            <div property="columns">
	...
	<div id="checkTempGrid" class="mini-datagrid" style="width: 100%; height: 40%;" url="${base}/check/allInfoSls/getCheckBrTemp.nut" pageSize="10" allowCellEdit="true" showPager="true"
