...
<script type="text/javascript" src="../js/modelRiskAll.js"></script>
...
<body>
	<div class="mini-toolbar" style="padding: 2px; border-bottom: 0;">
		<table style="width: 100%;">
			<tr>
				<td>日期：<input class="mini-datepicker" id="startDate">&nbsp;&nbsp;~&nbsp;&nbsp;<input class="mini-datepicker" id="endDate">&nbsp;&nbsp;排查进度：<input id="status" style="width: 150px;" class="mini-combobox" valueField="id" textField="text" data="statusData" emptyText="请选择" />&nbsp;&nbsp;<a class="mini-button" iconCls="icon-search" onclick="search" plain="true">查找</a></td>
			</tr>
		</table>
	</div>
	<div class="mini-fit">
