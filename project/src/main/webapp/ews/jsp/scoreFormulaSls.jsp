...
<script type="text/javascript" src="${base }/ews/js/scoreFormulaSls.js"></script>
<script>
	var flag = '${param.flag}'
</script>
</head>
	...
	<form id="editForm">
		<table class="tab" style="width: 100%; height: 20px;" cellpadding="6" cellspacing="0">
			...
			<tr>
				...
				<td class="tab_field_nr" style="width: 38%"><input class="mini-treeselect" id="parentCode" name="parentCode" url="${base}/score/formula/getSelectList.nut"
			...
			<tr>
				...
				<td class="tab_field_nr" colspan="3" style="height: 60px;"><input class="mini-textarea" required="true" id="scoreDesc" name="scoreDesc" value="${obj.scoreDesc}" style="width: 99%; height: 99%" /></td>
			</tr>
			<tr>
				<td class="tab_label">打分标准</td>
				<td class="tab_field_nr" colspan="3" style="height: 60px;"><input class="mini-textarea" required="true" id="scoreStandard" name="scoreStandard" value="${obj.scoreStandard}" style="width: 99%; height: 99%" /></td>
			</tr>
		</table>
	</form>
