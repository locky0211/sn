...
<script type="text/javascript" src="${base }/ews/js/checkResultSls.js"></script>
...
<c:if test="${dateformat =='1'}">
	...
	<div class="mini-fit">
		...
		<div id="checkDataGrid" multiSelect="true" class="mini-datagrid" url="${base}/check/result/sls/getCheckResultJN.nut?id=${param.id}&brNo=${param.brNo}&reportDate=${param.reportDate}&nbjgh=${param.nbjgh}"
