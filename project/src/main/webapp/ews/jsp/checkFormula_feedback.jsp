...
<script type="text/javascript" src="${base }/ews/js/checkFormula_feedback.js"></script>
<script>
	var id = '${obj.id}'
</script>
</head>
<body>
	<form id="editForm">
		<div style="display: none;">
			<input class="mini-hidden" id="feedbackid" name="feedbackid" value="${param.feedbackid}" /><input class="mini-hidden" id="formulaId" name="id" value="${obj.id}" /> <input class="mini-hidden" id="updateTime" name="updateTime" value="${obj.updateTime}" />
		</div>
		<table class="tab" style="width: 100%; height: 20px;" cellpadding="6" cellspacing="0">
			<tr>
				...
				<td class="tab_field_nr" style="width: 38%">
					<div id="repCode" name="repCode" class="mini-combobox" oncloseclick="onCloseClick" showClose="true" style="width: 98%;" popupWidth="350px" allowInput="true"
						url="${base}/sys/ggzd/getGgzdList.nut?groupId=EastTableName" textField="zdName" valueField="zdValue" value="${obj.repCode}">
				...
				<td class="tab_field_nr" style="width: 38%"><input class="mini-combobox" required="true" id="formulaType" name="formulaType" url="${base}/sys/ggzd/getGgzdList.nut?groupId=CheckType" textField="zdName" valueField="zdValue" value="${obj.formulaType}" style="width: 98%" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td class="tab_label">校验字段名</td>
				<td class="tab_field_nr" colspan="3"><input class="mini-textbox" required="true" id="fieldName" name="fieldName" value="${obj.fieldName}" style="width: 98%" /></td>
			</tr>
			<tr>
