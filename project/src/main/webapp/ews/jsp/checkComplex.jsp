...
<script type="text/javascript" src="${base }/ews/js/checkComplex.js"></script>
...
<div style="width: 100%;"id="checkForm">
	...
	<div class="mini-fit">
		<div id="checkGrid" class="mini-datagrid" style="width: 100%; height: 100%;" onrowdblclick="rowdblclick" url="${base}/check/complex/getResultList.nut" pageSize="20" allowCellEdit="true"
