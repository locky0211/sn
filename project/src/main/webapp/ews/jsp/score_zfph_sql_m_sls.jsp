...
<script type="text/javascript" src="${base }/ews/js/score_zfph_sql_m_sls.js"></script>
</head>
<body>
	...
	<div style="width: 100%;">
		<div class="mini-toolbar" style="border-bottom: 0; padding: 0px;">
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;">指标编号：<input id="zbbh" class="mini-textbox" style="width: 150px;" /><span class="separator"></span>
						<a iconCls="icon-add" class="mini-button" plain="true" onclick="add()">新增</a>
						
						 <a iconCls="icon-search"
						class="mini-button" plain="true" onclick="search()">查询</a> </td>
				</tr>
			</table>
		</div>
	</div>
	...
	<div class="mini-fit">
		<div id="scoreZfpgGrid" class="mini-datagrid" style="width: 100%; height: 100%;" url="${base}/scoreZfphSqlSls/getScoreZfphSqlSlsList.nut" pageSize="20" allowCellEdit="true" showPager="true" showModified="false">
