...
<script type="text/javascript" src="${base }/ews/js/checkResultSJ.js"></script>
...
<div style="width: 100%;"id="checkForm">
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;">机构<input name="brNo" id="brNo" class="mini-treeselect" url="${base }/sys/bm/getSysBmListByIsExistBmCategory.nut?bmCategory='EAST'" style="width: 240px;" parentField="pId"
						valueField="bmCode" multiSelect="true" showFolderCheckBox="true" oncloseclick="onCloseClick" showClose="true" textField="bmName" /><span class="separator"></span>报表日期:<input
                        id="reportDate" class="mini-DatePicker"  format="yyyy-MM-dd" style="width: 120px;"><span class="separator"></span> 表名称：
						...
						</div> <span class="separator"></span><a iconCls="icon-search" class="mini-button" plain="true"
						onclick="search()">查询</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a iconCls="icon-goto" class="mini-button" plain="true" onclick="excute()">开始校验</a>
	...
	<div class="mini-fit">
		<div id="checkGrid" class="mini-datagrid" style="width: 100%; height: 100%;" onrowdblclick="rowdblclick" url="${base}/check/resultsj/getResultList.nut" pageSize="20" allowCellEdit="true"
			showPager="true" showModified="false">
			<div property="columns">
				<div type="indexcolumn" align="center" width="15" headerAlign="center">序号</div>
				<div field="brNo" width="50" align="center" headerAlign="center">机构名称</div>
				...
				<div field="checkDesc" width="90" align="center" headerAlign="center">错误描述</div>
				<div field="sjrq" width="25" align="center" headerAlign="center">数据日期</div>
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;">机构<input name="brNo" required="true" id="brNo" class="mini-treeselect" url="${base }/sys/bm/getSysBmListByUserId.nut" style="width: 240px;" parentField="pId"
						...
						onclick="search_sd()">查询</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a iconCls="icon-goto" class="mini-button" plain="true" onclick="excute_sd()">开始校验</a>
	...
	<div class="mini-fit">
		<div id="checkGrid" class="mini-datagrid" style="width: 100%; height: 100%;" onrowdblclick="rowdblclick_sd" url="${base}/check/complexsd/getResultList.nut" pageSize="20" allowCellEdit="true"
			showPager="true" showModified="false">
			<div property="columns">
				<div type="indexcolumn" align="center" width="15" headerAlign="center">序号</div>
				<div name="zd_name" width="50" align="center" renderer="onNameRenderer" headerAlign="center">错误表名</div>
				...
				<div field="sjrq" width="20" align="center" headerAlign="center">数据日期</div>
				<div field="checkDate" width="20" align="center" headerAlign="center">校验日期</div>
			</div>
		</div>
	</div>
