...
<script type="text/javascript" src="${base }/ews/js/scoreFormula_m.js"></script>
</head>
<body>
	<div style="width: 100%;">
	...
	<div class="mini-fit">
		...
		imgPath="${base }/common/js/miniui/themes/icons/" url="${base}/score/formula/getSelectList.nut" allowAlternating="true">
