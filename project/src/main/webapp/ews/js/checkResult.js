$(function() {
	...
	$.ajax({
		url : base + 'check/result/getCheckResultStruct.nut?id=' + id + '&brNo=' + brNo,
		type : 'post',
		dataType : 'json',
...
function doExportExcel(id, exportAll) {
	...
	$.ajax({
		url : base + 'check/result/exportCheckResultToExcel.nut?id=' + id + '&brNo=' + brNo + '&reportDate=' + reportDate + '&exportAll=' + exportAll + '&pageIndex=' + pageIndex + '&pageSize='
...
function doExportExcel_sd(id, exportAll) {
	mini.mask({
		el : document.body,
		cls : 'mini-mask-loading',
		html : '导出excel处理中...'
	...
	var sortOrder = gird.getSortOrder();
	$.ajax({
		url : base + 'check/resultsd/exportCheckResultToExcel.nut?id=' + id + '&brNo=' + brNo + '&startDate=' + startDate + '&endDate=' + endDate + '&exportAll=' + exportAll + '&pageIndex=' + pageIndex + '&pageSize='
				+ pageSize + '&sortField=' + sortField + '&sortOrder=' + sortOrder,
		type : 'post',
		dataType : 'json',
		success : function(text) {
