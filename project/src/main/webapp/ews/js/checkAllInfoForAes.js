...
function onCancelRenderer(){
	var s='<a class="mini-button mini-button-plain" href="javascript:cancelRow()"><span class="mini-button-text  mini-button-icon icon-close">取消</span></a>';
	return s;
}
...
function rowdblclick() {
	var e = checkGrid.getSelected();
		mini.open({
			url : base + 'ews/jsp/checkAllInfoResultForAes.jsp?brNo=' + e.brNO + '&reportDate=' + e.sjRQ+'&formulaType=' +e.formulaType+'&version=' +e.version+'&tableRange=' +e.tableRange,
			title : "校验结果明细",
			width : 1000,
			height : 500,
			allowResize : true
