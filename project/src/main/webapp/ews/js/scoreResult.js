...
function updateRow() {
	...
	var json = data;
	$.ajax({
		url : base + "score/result/updateResult.nut",
		data : json,
		type : "post",
		dataType : "json",
...
function exportToExcel(){
	...
	$.ajax({
		url : base + 'score/result/exportToExcel.nut?brNo=' + mini.get("brNo").getValue() + '&reportDate=' + mini.get("reportDate").getText(),
		type : 'post',
		dataType : 'json',
		success : function(text) {
			if (!text.success) {
...
function excute() {
	if (mini.get("brNo").getValue() == '' || mini.get("brNo").getValue() == null) {
		...
		$.ajax({
			type : 'POST',
			dataType : 'json',
			url : base + 'score/result/startScore.nut?brNo=' + mini.get("brNo").getValue() + '&reportDate=' + mini.get("reportDate").getText(),
			success : function(text) {
				if (text.success) {
