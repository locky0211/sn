$(function() {   
	...
	$.ajax({
		url : base + 'check/result/sls/zdy/getCheckResultStruct.nut?id=' + id + '&brNo=' + brNo,
		type : 'post',
		dataType : 'json',
...
function doExportExcel(id, exportAll) {
	...
	$.ajax({
		url : base + 'check/result/sls/zdy/exportCheckResultToExcel.nut?id=' + id + '&brNo=' + brNo + '&reportDate=' + reportDate + '&nbjgh=' + nbjgh + '&exportAll=' + exportAll + '&pageIndex=' + pageIndex + '&pageSize='
