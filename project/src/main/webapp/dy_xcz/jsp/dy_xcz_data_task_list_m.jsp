...
<script type="text/javascript" src="${base }/dy_xcz/js/dy_xcz_data_task_list_m.js"></script>
</head>
<body>
	<div style="width: 100%;">
	...
	<div class="mini-fit">
		<div id="taskListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" url="${base}/dy_xcz/dm/getDyXczDataTaskList.nut" ondrawcell="ondrawcell"
