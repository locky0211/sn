...
<script type="text/javascript" src="${base}/dy_xcz/js/dy_check_formula_wave.js"></script>
</head>
			...
			<table cellpadding="4" cellspacing="4" style="padding-left: 12px;">
				<tr>
					...
					<td colspan="3"><input id="tabcode" name="tabcode" class="mini-textbox" required="true" onchange="isincludSpace" style="width: 400px;"
						value="${obj.tabcode }" onvaluechanged="onDeptChanged"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td valign="top">关注等级</td>
					<td colspan="3"><input id="checkRisk" name="checkRisk" class="mini-combobox" style="width: 150px;"  popupWidth="150" textField="zdName" valueField="zdValue" url="${base }/sys/ggzd/getGgzdList.nut?groupId=WAVE_CHECK_RISK" required="true"
						multiSelect="false" value="${obj.checkRisk}" allowInput="false" showClose="true" oncloseclick="onCloseClick" /></td>
				</tr>
				<tr>
					<td>校验频度</td>
					<td><input id="reportRate" name="reportRate" class="mini-combobox" style="width: 150px;"  popupWidth="150" textField="zdName" valueField="zdValue" url="${base }/sys/ggzd/getGgzdList.nut?groupId=DY_YIDONG_FORMULA_TYPE" required="true"
						multiSelect="true" value="${obj.reportRate}" allowInput="false" showClose="true" oncloseclick="onCloseClick" /></td>
					<td>阈值：</td>
				...
				<tr>
					...
					<td><input id="thisVersion" name="thisVersion" style="width: 150px;" showClose="true" oncloseclick="onCloseClick"
						class="mini-combobox" url="${base }/dy_xcz/table/getTableVersionNo.nut?tabCode=${obj.tabcode }" textField="versionNo" multiSelect="false" 
