...
<script type="text/javascript" src="../js/dy_table_info_m.js"></script>
</head>
<body>
	...
	<!--撑满页面-->
	<div class="mini-fit">
		<div id="tableInfoGrid"  allowAlternating="true"  class="mini-datagrid" style="width: 100%; height: 100%" url="${base}/dy_xcz/table/getTableBasicInfoList.nut" showPager="false"
			showModified="false">
