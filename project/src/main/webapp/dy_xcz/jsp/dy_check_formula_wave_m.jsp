...
<script type="text/javascript" src="../js/dy_check_formula_wave_m.js"></script>
</head>
<body>
	...
	<div class="mini-fit">
		<div id="checkFormulaGrid" class="mini-datagrid" style="width: 100%; height: 100%;"
			url="${base}/dy_xcz/check/wave/getDyCheckFormulaWaveList.nut" allowAlternating="true" pageSize="100" multiSelect="true"
			showModified="false">
