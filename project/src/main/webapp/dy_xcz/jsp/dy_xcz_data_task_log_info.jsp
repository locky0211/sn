...
<script type="text/javascript" src="${base }/dy_xcz/js/dy_xcz_data_task_log_info.js"></script>
</head>
<body>
	<div style="width: 100%;">
	...
	<div class="mini-fit">
		<div id="dmImportLogInfoGrid" class="mini-datagrid" style="width: 100%; height: 100%;" url="${base}/dy_xcz/dmLog/getImportLogInfoList.nut" pageSize="50"
			showPager="true">
			<div property="columns">
				<div field="dataDate" align="center" width="30" headerAlign="center">报表日期</div>
				<div field="dataType" align="center" width="30" headerAlign="center" renderer="reportTypeRenderer">报表类型</div>
				<div field="handleDate" dateFormat="yyyy-MM-dd HH:mm:ss" width="50" align="center" headerAlign="center">处理时间</div>
				...
				<div field="taskState" width="40" renderer="onDoRender" align="center" headerAlign="center">操作</div>
			</div>
		</div>
	</div>
