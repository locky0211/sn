...
<script type="text/javascript" src="${base }/dy_xcz/js/dy_xcz_import_task_part.js"></script>
...
<body>
	...
	<div class="mini-fit">
		<div id="taskGrid" style="width: 100%; height: 100%;" class="mini-datagrid" url="${base}/dy_xcz/dm/getDmDataTaskListHelp.nut?dataDate=${param.dataDate }&dataType=${param.dataType }"
