...
function viewDetail(e) {
	var row = e.record;
	mini.open({
		url : base + "ci/reportTable/getReportDataDetailJy.nut?tableCode=" + tableCode
...
function doExportExcel(id, tableCode, fieldName,reportDate, exportAll) {
	mini.mask({
		el : document.body,
		cls : 'mini-mask-loading',
		html : '导出excel处理中...'
	...
	$.ajax({
		url : base + 'ci/reportTable/exportCheckResultToExcel.nut?id=' + id + '&tableCode=' + tableCode + '&fieldName=' + fieldName + '&reportDate=' + reportDate + '&exportAll=' + exportAll + '&pageIndex=' + pageIndex + '&pageSize='
