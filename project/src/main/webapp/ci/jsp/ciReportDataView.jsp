...
<script type="text/javascript" src="../js/ciReportDataView.js"></script>
</head>
<body>
<div id="indDataForm" method="post">
				...
				<tr>
					<td style="white-space: nowrap;"><a class="mini-menubutton " id="exportExcelBtn" menu="#popupMenu" iconCls="icon-excel">导出..</a>
						<ul id="popupMenu" class="mini-menu" style="display: none;">
							<li iconCls="icon-excel" onclick="doExportExcel('${param.tableCode}',false)">导出当前页</li>
							<li iconCls="icon-excel" onclick="doExportExcel('${param.tableCode}',true)">导出所有数据</li>
						</ul></td>
				</tr>
			</table>
		</div>
	...
	<div class="mini-fit">
		<div id="ciReportDataGrid" multiSelect="true" class="mini-datagrid" url="${base}/ci/reportTable/getReportDataList.nut" style="width: 100%; height: 100%"
