...
<script type="text/javascript" src="${base }/dl/js/dlReportSummaryDEEdit.js"></script>
</head>
<body>
	<form id="editForm">
		...
		<table class="tab" style="width: 100%; height: 20px;" cellpadding="6" cellspacing="0">
			...
			<tr>
				<td class="tab_label_nr" colspan="8" style="text-align: center">取数语句</td>
			</tr>
			<tr>
				<td class="tab_field_nr" colspan="8" style="height: 120px; text-align: center">
					<input class="mini-textarea" required="true" id="dataSql" name="dataSql" value="${obj.dataSql}" style="width: 100%; height: 98%" />
				</td>
			</tr>
		</table>
	</form>
