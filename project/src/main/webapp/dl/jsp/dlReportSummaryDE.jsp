...
<script type="text/javascript" src="${base }/dl/js/dlReportSummaryDE.js"></script>
</head>
<body>
	<div style="width: 100%;">
	...
	<div class="mini-fit">
		<div id="reportSummaryGrid" class="mini-datagrid" style="width: 100%; height: 100%;" url="${base}/dl/reportSummary/getReportSummaryDEList.nut" 
