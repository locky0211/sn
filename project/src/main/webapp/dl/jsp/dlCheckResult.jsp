...
<script type="text/javascript">
	var formulaId = '${param.id}';//公式ID
	var brNo= '${param.brNo}';
	var reportDate= '${param.reportDate}';
	var tabCode = '${param.tabCode}';
	var fieldCode = '${param.fieldCode}';
</script>
<script type="text/javascript" src="${base }/dl/js/dlCheckResult.js"></script>
</head>
<body>
<div id="indDataForm" method="post">
	...
	<div class="mini-fit">
		<div id="checkDataGrid" multiSelect="true" class="mini-datagrid" url="${base}/dl/result/getCheckResult.nut?id=${param.id}&brNo=${param.brNo}&reportDate=${param.reportDate}" style="width: 100%; height: 100%"
