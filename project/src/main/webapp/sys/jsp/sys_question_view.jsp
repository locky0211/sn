...
<body>
	<div id="layout1" class="mini-layout" style="width: 100%; height: 100%;" splitSize="0">
		<div title="north" region="north" height="140" bodyStyle="word-break:break-all;padding-left:5px;" showHeader="false" showSplit="false"
			allowResize="false"><br>
			<p class="pTitle">${obj.title }</p>
			<div style="float: right; font-size: 12px;">发布人:&nbsp;${obj.createuser }&nbsp;&nbsp;</div><br>
			<div style="float: right; font-size: 12px;">发布时间:&nbsp;${obj.createtime }&nbsp;&nbsp;</div><br>
			<div style="float: right; font-size: 12px;">更新时间:&nbsp;${obj.updatetime }&nbsp;&nbsp;</div>
		</div>
