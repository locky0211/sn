...
<script type="text/javascript" src="../js/sys_schedule_nj_m.js"></script>
</head>
<body>
	...
	<div class="mini-fit">
		<div id="scheduleGrid" class="mini-datagrid" style="width: 100%; height: 100%;" url="${base}/sys/schedule/getScheduleList.nut" pageSize="10" allowCellEdit="true"
			...
			<div property="columns">
				...
				<div field="dataBatch" width="30" headerAlign="center" align="center" renderer="dataBatchRenderer">报表批次</div>
