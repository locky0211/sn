...
<script type="text/javascript" src="${base }/sys/js/sys_help.js"></script>
<title>公告信息</title>
</head>
<body style="overflow: auto;">
	<form id="sysNoticeForm" method="post">
		...
		<table style="width: 100%" cellpadding="5" cellspacing="0">
			<tr>
				<td class="tab_label" style="width: 100px; text-align: right;">模&nbsp;式&nbsp;：</td>
				<td class="tab_field_nr"><input id="schemaType" name="schemaType" style="width: 500px;" vtype="maxLength:50" class="mini-textbox" required="true"
					value="${obj.schemaType }" /></td>
			</tr>
			<tr>
