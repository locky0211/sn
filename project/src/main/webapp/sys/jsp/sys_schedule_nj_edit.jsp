...
<script type="text/javascript" src="../js/sys_schedule_nj_edit.js"></script>
</head>
		...
		<div>
			<table class="tab" style="width: 100%; height: 100px;" cellpadding="6" cellspacing="0">
				...
				<tr>
					...
					<tr>
					<td class="tab_label" style="width: 28%" align="center">报表批次：</td>
					<td class="tab_field_nr">
							<input id="dataBatch" name="dataBatch" style="width: 98%;" class="mini-combobox" required="true"  
							url="${base }/sys/ggzd/getGgzdList.nut?groupId=RD_DATA_BATCH" parentField="pId" 
							valueField="zdValue" textField="zdName" allowInput="false" emptyText="请选择报表批次" value="${obj.dataBatch }" />
					</td>
				</tr>
			</table>
		</div>
