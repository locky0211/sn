...
<script type="text/javascript" src="../js/sys_org_summer_add.js"></script>
</head>
				...
				<tr>
					...
					<td class="tab_field_nr">
						<input id="subCode" name="subCode" popupHeight="250px;" popupWidth="350px;" required="true" style="width: 98%;"
							class="mini-treeselect" url="${base}/sys/bm/getSysBmList.nut"  textField="bmName" multiSelect="true" showFolderCheckBox="true" parentField="pId" valueField="bmCode" allowInput="false"
							resultAsTree="false" showClose="true" oncloseclick="onCloseClick" checkRecursive="true" allowSelect="true"/>
					</td>
				</tr>
			</table>
		</div>
