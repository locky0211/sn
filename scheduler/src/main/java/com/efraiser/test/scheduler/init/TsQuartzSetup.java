...
import com.efraiser.test.scheduler.manager.ts.TsQuartzJob;
import com.efraiser.test.scheduler.manager.ts.TsSchedulerManager;
...
public class TsQuartzSetup {
    ...
    @Autowired
    private TsSchedulerManager tsSchedulerManager;
    ...
    public void init() {
        ...
        for (TsTaskCycle tc : tcList) {
            tsSchedulerManager.addJob(tc, TsQuartzJob.class);
        }
