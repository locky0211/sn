package com.efraiser.test.db.service.rd.rdtableinfos;
...
public interface RdTableInfosService extends BaseService {
    ...
    RdTableBasicInfo saveOrUpdateTableInfo(RdTableInfo tableInfo, List<RdTableModel> tableModels, String model, List<RdTableModelPCT> tableModelPCTs, List<RdTableColumnContrast> rccList) throws Exception;
    ...
    RdTableInfo getTableInfoByTabCodeAndReportDate(String tabCodes,
                                                   String reportDate);

    Object getRdtableInfoListByBmType(SysUser sysUser, String bmType,
                                      String bmCategory, String reportDate);

    Object getRdtableInfoListByBmTypeEx(SysUser sysUser, String bmType,
                                        String bmCategory, String reportDate);
    ...
    List<RdTableInfo> getListByTabcodeAndReportDate(String tabcode,
                                                    String reportDate);
