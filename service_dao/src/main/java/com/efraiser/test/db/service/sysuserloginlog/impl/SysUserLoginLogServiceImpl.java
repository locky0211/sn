package com.efraiser.test.db.service.sysuserloginlog.impl;

import com.efraiser.test.common.util.DateUtil;
import com.efraiser.test.db.model.SysUser;
import com.efraiser.test.db.model.SysUserLoginLog;
...
@Service
public class SysUserLoginLogServiceImpl extends BaseServiceImpl<SysUserLoginLog> implements SysUserLoginLogService<SysUserLoginLog> {
